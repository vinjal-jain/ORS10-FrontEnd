...
module.exports = "<app-navbar></app-navbar>\r\n\r\n<style>\r\n  .grad {\r\n    background-image: linear-gradient(to bottom right, rgb(32, 168, 168), rgb(219, 231, 237));\r\n    background-repeat: no-repeat;\r\n    background-size: 100%;\r\n    padding-bottom: 25px;\r\n  }\r\n\r\n  .background {\r\n    padding-top: 3%;\r\n    padding-bottom: 13%;\r\n    background: url('assets/files/wall.jpg') no-repeat center center;\r\n    background-attachment: fixed;\r\n    background-size: cover;\r\n    width: 100%;\r\n    height: auto;\r\n  }\r\n\r\n  .required-field {\r\n    color: red;\r\n  }\r\n\r\n  .alertRedColor {\r\n    color: red;\r\n  }\r\n</style>\r\n\r\n<div class=\"container-fluid background\" style=\"padding-top:12%\">\r\n  <div class=\"row justify-content-center\">\r\n    <div class=\"col-sm-8 col-md-6 col-lg-4\">\r\n      <div class=\"card\">\r\n        <div class=\"card-body shadow-lg grad\">\r\n\r\n          <form name=\"activityForm\">\r\n\r\n            <h2 *ngIf=\"!form.data.id\" class=\"text-primary font-weight-bold text-center\">\r\n              Add Activity\r\n            </h2>\r\n            <h2 *ngIf=\"form.data.id\" class=\"text-primary font-weight-bold text-center\">\r\n              Update Activity\r\n            </h2>\r\n\r\n            <!-- Messages -->\r\n            <div *ngIf=\"form.error && form.message\" class=\"alert alert-danger alert-dismissible fade show\">\r\n              <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n              {{ form.message }}\r\n            </div>\r\n\r\n            <div *ngIf=\"!form.error && form.message\" class=\"alert alert-success alert-dismissible fade show\">\r\n              <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n              {{ form.message }}\r\n            </div>\r\n\r\n            <!-- Activity Name -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Activity Name</b><span class=\"required-field\">*</span></label>\r\n              <input type=\"text\" name=\"activityName\" [(ngModel)]=\"form.data.activityName\" class=\"form-control\"\r\n                placeholder=\"Enter Activity Name\">\r\n              <span *ngIf=\"form.inputerror.activityName\" class=\"alertRedColor\">\r\n                {{ form.inputerror.activityName }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Performed By -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Performed By</b><span class=\"required-field\">*</span></label>\r\n              <input type=\"text\" name=\"performedBy\" [(ngModel)]=\"form.data.performedBy\" class=\"form-control\"\r\n                placeholder=\"Enter Performer Name\">\r\n              <span *ngIf=\"form.inputerror.performedBy\" class=\"alertRedColor\">\r\n                {{ form.inputerror.performedBy }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Activity Time -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Activity Time</b><span class=\"required-field\">*</span></label>\r\n              <input type=\"datetime-local\" name=\"activityTime\"\r\n                [value]=\"form.data.activityTime | date:'yyyy-MM-ddTHH:mm'\"\r\n                (input)=\"form.data.activityTime=parseDate($event.target.value)\" class=\"form-control\">\r\n              <span *ngIf=\"form.inputerror.activityTime\" class=\"alertRedColor\">\r\n                {{ form.inputerror.activityTime }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Status -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Status</b><span class=\"required-field\">*</span></label>\r\n              <select class=\"form-control\" name=\"activityStatus\" [(ngModel)]=\"form.data.activityStatus\">\r\n                <option [ngValue]=\"undefined\">Select Status</option>\r\n                <option *ngFor=\"let s of form.preload.activityStatusList | keyvalue\" [value]=\"s.value\">\r\n                  {{ s.value }}\r\n                </option>\r\n              </select>\r\n              <span *ngIf=\"form.inputerror.activityStatus\" class=\"alertRedColor\">\r\n                {{ form.inputerror.activityStatus }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Buttons -->\r\n            <div class=\"row pt-2 pl-2 pb-3\">\r\n              <div class=\"col-md-3\"></div>\r\n\r\n              <div class=\"pt-2\">\r\n                <button *ngIf=\"!form.data.id > 0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\r\n                  Save\r\n                </button>\r\n              </div>\r\n\r\n              <div class=\"col-md-1\"></div>\r\n\r\n              <div class=\"pt-2\">\r\n                <button *ngIf=\"form.data.id > 0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\r\n                  Update\r\n                </button>\r\n              </div>\r\n\r\n              <div class=\"pt-2\">\r\n                <a class=\"btn btn-warning mr-1\" [routerLink]=\"['/activitylist']\"\r\n                  style=\"color:white;text-decoration:none\">\r\n                  List\r\n                </a>\r\n              </div>\r\n            </div>\r\n\r\n          </form>\r\n\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<app-footer></app-footer>\r\n<app-navbar></app-navbar>\r\n\r\n<style>\r\n  .grad {\r\n    background-image: linear-gradient(to bottom right, rgb(32, 168, 168), rgb(219, 231, 237));\r\n    background-repeat: no-repeat;\r\n    background-size: 100%;\r\n    padding-bottom: 25px;\r\n  }\r\n\r\n  .background {\r\n    padding-top: 3%;\r\n    padding-bottom: 13%;\r\n    background: url('assets/files/wall.jpg') no-repeat center center;\r\n    background-attachment: fixed;\r\n    background-size: cover;\r\n    width: 100%;\r\n    height: auto;\r\n  }\r\n\r\n  .required-field {\r\n    color: red;\r\n  }\r\n\r\n  .alertRedColor {\r\n    color: red;\r\n  }\r\n</style>\r\n\r\n<div class=\"container-fluid background\" style=\"padding-top:12%\">\r\n  <div class=\"row justify-content-center\">\r\n    <div class=\"col-sm-8 col-md-6 col-lg-4\">\r\n      <div class=\"card\">\r\n        <div class=\"card-body shadow-lg grad\">\r\n\r\n          <form name=\"activityForm\">\r\n\r\n            <h2 *ngIf=\"!form.data.id\" class=\"text-primary font-weight-bold text-center\">\r\n              Add Activity\r\n            </h2>\r\n            <h2 *ngIf=\"form.data.id\" class=\"text-primary font-weight-bold text-center\">\r\n              Update Activity\r\n            </h2>\r\n\r\n            <!-- Messages -->\r\n            <div *ngIf=\"form.error && form.message\" class=\"alert alert-danger alert-dismissible fade show\">\r\n              <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n              {{ form.message }}\r\n            </div>\r\n\r\n            <div *ngIf=\"!form.error && form.message\" class=\"alert alert-success alert-dismissible fade show\">\r\n              <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n              {{ form.message }}\r\n            </div>\r\n\r\n            <!-- Activity Name -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Activity Name</b><span class=\"required-field\">*</span></label>\r\n              <input type=\"text\" name=\"activityName\" [(ngModel)]=\"form.data.activityName\" class=\"form-control\"\r\n                placeholder=\"Enter Activity Name\">\r\n              <span *ngIf=\"form.inputerror.activityName\" class=\"alertRedColor\">\r\n                {{ form.inputerror.activityName }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Performed By -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Performed By</b><span class=\"required-field\">*</span></label>\r\n              <input type=\"text\" name=\"performedBy\" [(ngModel)]=\"form.data.performedBy\" class=\"form-control\"\r\n                placeholder=\"Enter Performer Name\">\r\n              <span *ngIf=\"form.inputerror.performedBy\" class=\"alertRedColor\">\r\n                {{ form.inputerror.performedBy }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Activity Time -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Activity Time</b><span class=\"required-field\">*</span></label>\r\n              <input type=\"datetime-local\" name=\"activityTime\"\r\n                [value]=\"form.data.activityTime | date:'yyyy-MM-ddTHH:mm'\"\r\n                (input)=\"form.data.activityTime=parseDate($event.target.value)\" class=\"form-control\">\r\n              <span *ngIf=\"form.inputerror.activityTime\" class=\"alertRedColor\">\r\n                {{ form.inputerror.activityTime }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Status -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Status</b><span class=\"required-field\">*</span></label>\r\n              <select class=\"form-control\" name=\"activityStatus\" [(ngModel)]=\"form.data.activityStatus\">\r\n                <option [ngValue]=\"undefined\">Select Status</option>\r\n                <option *ngFor=\"let s of form.preload.activityStatusList | keyvalue\" [value]=\"s.value\">\r\n                  {{ s.value }}\r\n                </option>\r\n              </select>\r\n              <span *ngIf=\"form.inputerror.activityStatus\" class=\"alertRedColor\">\r\n                {{ form.inputerror.activityStatus }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Buttons -->\r\n            <div class=\"row pt-2 pl-2 pb-3\">\r\n              <div class=\"col-md-3\"></div>\r\n\r\n              <div class=\"pt-2\">\r\n                <button *ngIf=\"!form.data.id > 0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\r\n                  Save\r\n                </button>\r\n              </div>\r\n\r\n              <div class=\"col-md-1\"></div>\r\n\r\n              <div class=\"pt-2\">\r\n                <button *ngIf=\"form.data.id > 0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\r\n                  Update\r\n                </button>\r\n              </div>\r\n\r\n              <div class=\"pt-2\">\r\n                <a class=\"btn btn-warning mr-1\" [routerLink]=\"['/activitylist']\"\r\n                  style=\"color:white;text-decoration:none\">\r\n                  List\r\n                </a>\r\n              </div>\r\n            </div>\r\n\r\n          </form>\r\n\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<app-footer></app-footer>"
...
var ActivityComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ActivityComponent, _super);
    function ActivityComponent(locator, route) {
        return _super.call(this, locator.endpoints.ACTIVITY, locator, route) || this;
    }
    ActivityComponent.prototype.validateForm = function (form) {
        var v = this.serviceLocator.dataValidator;
    ...
    ActivityComponent.prototype.populateForm = function (form, data) {
        form.id = data.id;
...
/***/ "./src/app/activity/activitylist.component.html":
/*!******************************************************!*\
  !*** ./src/app/activity/activitylist.component.html ***!
  \******************************************************/
/*! no static exports found */
...
module.exports = "<app-navbar></app-navbar>\r\n\r\n<div class=\"content-wrapper\" style=\"padding-top:12%\">\r\n  <div class=\"container-fluid\">\r\n\r\n    <h1 class=\"text-primary text-center\">Activity List</h1>\r\n\r\n    <!-- Search -->\r\n    <div class=\"row search-inputs p-2 justify-content-center\">\r\n\r\n      <div class=\"col-sm-2\">\r\n        <input type=\"text\" class=\"form-control\" [(ngModel)]=\"form.searchParams.activityName\"\r\n          placeholder=\"Activity Name\">\r\n      </div>\r\n\r\n      <div class=\"col-sm-2\">\r\n        <input type=\"text\" class=\"form-control\" [(ngModel)]=\"form.searchParams.performedBy\" placeholder=\"Performed By\">\r\n      </div>\r\n\r\n      <div class=\"col-sm-2\">\r\n        <select class=\"form-control\" [(ngModel)]=\"form.searchParams.activityStatus\">\r\n          <option [ngValue]=\"undefined\">Select Status</option>\r\n          <option *ngFor=\"let s of form.preload.activityStatusList | keyvalue\" [value]=\"s.value\">\r\n            {{ s.value }}\r\n          </option>\r\n        </select>\r\n      </div>\r\n\r\n      <div class=\"col-sm-1\">\r\n        <button class=\"btn btn-primary w-100\" (click)=\"submit()\">Search</button>\r\n      </div>\r\n\r\n      <div>\r\n        <button class=\"btn btn-success w-100\" (click)=\"forward('/activity')\">\r\n          Add Activity\r\n        </button>\r\n      </div>\r\n\r\n      <div class=\"col-sm-1\">\r\n        <button class=\"btn btn-danger w-100\" (click)=\"deleteMany()\">Delete</button>\r\n      </div>\r\n    </div>\r\n\r\n    <!-- Messages -->\r\n    <div *ngIf=\"form.error && form.message\" class=\"alert alert-danger alert-dismissible fade show\">\r\n      <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n      {{ form.message }}\r\n    </div>\r\n\r\n    <div *ngIf=\"!form.error && form.message\" class=\"alert alert-success alert-dismissible fade show\">\r\n      <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n      {{ form.message }}\r\n    </div>\r\n\r\n    <!-- Table -->\r\n    <table class=\"table table-bordered table-dark mt-3\">\r\n      <thead>\r\n        <tr align=\"center\">\r\n          <th>\r\n            <input type=\"checkbox\" [(ngModel)]=\"isMasterSel\" (change)=\"checkUncheckAll($event)\">\r\n          </th>\r\n          <th>S.No</th>\r\n          <th>Name</th>\r\n          <th>Performed By</th>\r\n          <th>Time</th>\r\n          <th>Status</th>\r\n          <th>Edit</th>\r\n        </tr>\r\n      </thead>\r\n\r\n      <tbody>\r\n        <tr *ngFor=\"let a of form.list; let i=index\" align=\"center\">\r\n          <td>\r\n            <input type=\"checkbox\" #checkboxes [id]=\"a.id\" (change)=\"checklistUpdate()\">\r\n          </td>\r\n          <td>{{ (form.pageNo * 5) + i + 1 }}</td>\r\n          <td>{{ a.activityName }}</td>\r\n          <td>{{ a.performedBy }}</td>\r\n          <td>{{ a.activityTime }}</td>\r\n          <td>{{ a.activityStatus }}</td>\r\n          <td>\r\n            <button class=\"fa fa-edit text-primary\" (click)=\"forward('/activity/' + a.id)\">\r\n            </button>\r\n          </td>\r\n        </tr>\r\n      </tbody>\r\n    </table>\r\n\r\n    <!-- Pagination + Reset -->\r\n    <div class=\"d-flex justify-content-between mt-3\">\r\n\r\n      <button class=\"btn btn-info\" (click)=\"previous()\" [disabled]=\"form.pageNo == 0\">\r\n        Previous\r\n      </button>\r\n\r\n      <div>\r\n        <a class=\"btn btn-warning mr-1\" [routerLink]=\"['/activitylist']\" (click)=\"exit()\">\r\n          Reset\r\n        </a>\r\n      </div>\r\n\r\n      <button class=\"btn btn-info\" (click)=\"next()\" [disabled]=\"nextList == 0\">\r\n        Next\r\n      </button>\r\n\r\n    </div>\r\n\r\n  </div>\r\n</div>\r\n\r\n<app-footer></app-footer>"

/***/ }),

/***/ "./src/app/activity/activitylist.component.ts":
/*!****************************************************!*\
  !*** ./src/app/activity/activitylist.component.ts ***!
  \****************************************************/
...
var ActivitylistComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ActivitylistComponent, _super);
    function ActivitylistComponent(locator, route) {
        return _super.call(this, locator.endpoints.ACTIVITY, locator, route) || this;
    }
    ActivitylistComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-activitylist',
            template: __webpack_require__(/*! ./activitylist.component.html */ "./src/app/activity/activitylist.component.html")
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_locator_service__WEBPACK_IMPORTED_MODULE_4__["ServiceLocatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])
...
/* harmony import */ var _position_position_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./position/position.component */ "./src/app/position/position.component.ts");
/* harmony import */ var _position_position_list_component__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./position/position-list.component */ "./src/app/position/position-list.component.ts");
...
/* harmony import */ var _order_orderlist_component__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./order/orderlist.component */ "./src/app/order/orderlist.component.ts");
/* harmony import */ var _offer_offer_component__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ./offer/offer.component */ "./src/app/offer/offer.component.ts");
/* harmony import */ var _offer_offerlist_component__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ./offer/offerlist.component */ "./src/app/offer/offerlist.component.ts");
/* harmony import */ var _settings_settings_component__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! ./settings/settings.component */ "./src/app/settings/settings.component.ts");
/* harmony import */ var _settings_settingslist_component__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(/*! ./settings/settingslist.component */ "./src/app/settings/settingslist.component.ts");
...
/* harmony import */ var _activity_activity_component__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ./activity/activity.component */ "./src/app/activity/activity.component.ts");
/* harmony import */ var _activity_activitylist_component__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(/*! ./activity/activitylist.component */ "./src/app/activity/activitylist.component.ts");
/* harmony import */ var _contract_contract_component__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(/*! ./contract/contract.component */ "./src/app/contract/contract.component.ts");
/* harmony import */ var _contract_contractlist_component__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(/*! ./contract/contractlist.component */ "./src/app/contract/contractlist.component.ts");
/* harmony import */ var _inquiry_inquiry_component__WEBPACK_IMPORTED_MODULE_52__ = __webpack_require__(/*! ./inquiry/inquiry.component */ "./src/app/inquiry/inquiry.component.ts");
/* harmony import */ var _inquiry_inquirylist_component__WEBPACK_IMPORTED_MODULE_53__ = __webpack_require__(/*! ./inquiry/inquirylist.component */ "./src/app/inquiry/inquirylist.component.ts");
/* harmony import */ var _audit_audit_component__WEBPACK_IMPORTED_MODULE_54__ = __webpack_require__(/*! ./audit/audit.component */ "./src/app/audit/audit.component.ts");
/* harmony import */ var _audit_auditlist_component__WEBPACK_IMPORTED_MODULE_55__ = __webpack_require__(/*! ./audit/auditlist.component */ "./src/app/audit/auditlist.component.ts");
...
var routes = [
    ...
    {
        path: 'audit',
        component: _audit_audit_component__WEBPACK_IMPORTED_MODULE_54__["AuditComponent"]
    },
    {
        path: 'auditlist',
        component: _audit_auditlist_component__WEBPACK_IMPORTED_MODULE_55__["AuditlistComponent"]
    },
    {
        path: 'audit/:id',
        component: _audit_audit_component__WEBPACK_IMPORTED_MODULE_54__["AuditComponent"]
    ...
    {
        path: 'inquiry',
        component: _inquiry_inquiry_component__WEBPACK_IMPORTED_MODULE_52__["InquiryComponent"]
    },
    {
        path: 'inquirylist',
        component: _inquiry_inquirylist_component__WEBPACK_IMPORTED_MODULE_53__["InquirylistComponent"]
    },
    {
        path: 'inquiry/:id',
        component: _inquiry_inquiry_component__WEBPACK_IMPORTED_MODULE_52__["InquiryComponent"]
    ...
    {
        path: 'contract',
        component: _contract_contract_component__WEBPACK_IMPORTED_MODULE_50__["ContractComponent"]
    },
    {
        path: 'contractlist',
        component: _contract_contractlist_component__WEBPACK_IMPORTED_MODULE_51__["ContractlistComponent"]
    },
    {
        path: 'contract/:id',
        component: _contract_contract_component__WEBPACK_IMPORTED_MODULE_50__["ContractComponent"]
    ...
    {
        path: 'activity',
        component: _activity_activity_component__WEBPACK_IMPORTED_MODULE_48__["ActivityComponent"]
    },
    {
        path: 'activitylist',
        component: _activity_activitylist_component__WEBPACK_IMPORTED_MODULE_49__["ActivitylistComponent"]
    },
    {
        path: 'activity/:id',
        component: _activity_activity_component__WEBPACK_IMPORTED_MODULE_48__["ActivityComponent"]
    ...
    {
        path: 'client',
        component: _client_client_component__WEBPACK_IMPORTED_MODULE_46__["ClientComponent"]
    },
    {
        path: 'clientlist',
        component: _client_clientlist_component__WEBPACK_IMPORTED_MODULE_47__["ClientlistComponent"]
    },
    {
        path: 'client/:id',
        component: _client_client_component__WEBPACK_IMPORTED_MODULE_46__["ClientComponent"]
    ...
    {
        path: 'settings',
        component: _settings_settings_component__WEBPACK_IMPORTED_MODULE_44__["SettingsComponent"]
    },
    {
        path: 'settings/:id',
        component: _settings_settings_component__WEBPACK_IMPORTED_MODULE_44__["SettingsComponent"]
    ...
    {
        path: 'settingslist',
        component: _settings_settingslist_component__WEBPACK_IMPORTED_MODULE_45__["SettingslistComponent"]
    },
    // ***********OFFER*************
    {
        path: 'offer',
        component: _offer_offer_component__WEBPACK_IMPORTED_MODULE_42__["OfferComponent"]
    },
    {
        path: 'offerlist',
        component: _offer_offerlist_component__WEBPACK_IMPORTED_MODULE_43__["OfferlistComponent"]
    },
    {
        path: 'offer/:id',
        component: _offer_offer_component__WEBPACK_IMPORTED_MODULE_42__["OfferComponent"]
    ...
    {
        path: 'orderlist',
        component: _order_orderlist_component__WEBPACK_IMPORTED_MODULE_41__["OrderlistComponent"]
    },
    {
        path: 'order/:id',
        component: _order_order_component__WEBPACK_IMPORTED_MODULE_40__["OrderComponent"]
    ...
    {
        path: 'position',
        component: _position_position_component__WEBPACK_IMPORTED_MODULE_38__["PositionComponent"]
    },
    {
        path: 'positionlist',
        component: _position_position_list_component__WEBPACK_IMPORTED_MODULE_39__["PositionListComponent"]
    },
    {
        path: 'position/:id',
        component: _position_position_component__WEBPACK_IMPORTED_MODULE_38__["PositionComponent"]
...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        ...
        if (!src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_2__["environment"].production) {
...
/* harmony import */ var _position_position_component__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(/*! ./position/position.component */ "./src/app/position/position.component.ts");
/* harmony import */ var _position_position_list_component__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(/*! ./position/position-list.component */ "./src/app/position/position-list.component.ts");
...
/* harmony import */ var _offer_offer_component__WEBPACK_IMPORTED_MODULE_54__ = __webpack_require__(/*! ./offer/offer.component */ "./src/app/offer/offer.component.ts");
/* harmony import */ var _offer_offerlist_component__WEBPACK_IMPORTED_MODULE_55__ = __webpack_require__(/*! ./offer/offerlist.component */ "./src/app/offer/offerlist.component.ts");
/* harmony import */ var _settings_settings_component__WEBPACK_IMPORTED_MODULE_56__ = __webpack_require__(/*! ./settings/settings.component */ "./src/app/settings/settings.component.ts");
/* harmony import */ var _settings_settingslist_component__WEBPACK_IMPORTED_MODULE_57__ = __webpack_require__(/*! ./settings/settingslist.component */ "./src/app/settings/settingslist.component.ts");
/* harmony import */ var _client_client_component__WEBPACK_IMPORTED_MODULE_58__ = __webpack_require__(/*! ./client/client.component */ "./src/app/client/client.component.ts");
/* harmony import */ var _client_clientlist_component__WEBPACK_IMPORTED_MODULE_59__ = __webpack_require__(/*! ./client/clientlist.component */ "./src/app/client/clientlist.component.ts");
/* harmony import */ var _activity_activitylist_component__WEBPACK_IMPORTED_MODULE_60__ = __webpack_require__(/*! ./activity/activitylist.component */ "./src/app/activity/activitylist.component.ts");
/* harmony import */ var _activity_activity_component__WEBPACK_IMPORTED_MODULE_61__ = __webpack_require__(/*! ./activity/activity.component */ "./src/app/activity/activity.component.ts");
/* harmony import */ var _contract_contract_component__WEBPACK_IMPORTED_MODULE_62__ = __webpack_require__(/*! ./contract/contract.component */ "./src/app/contract/contract.component.ts");
/* harmony import */ var _contract_contractlist_component__WEBPACK_IMPORTED_MODULE_63__ = __webpack_require__(/*! ./contract/contractlist.component */ "./src/app/contract/contractlist.component.ts");
/* harmony import */ var _inquiry_inquiry_component__WEBPACK_IMPORTED_MODULE_64__ = __webpack_require__(/*! ./inquiry/inquiry.component */ "./src/app/inquiry/inquiry.component.ts");
/* harmony import */ var _inquiry_inquirylist_component__WEBPACK_IMPORTED_MODULE_65__ = __webpack_require__(/*! ./inquiry/inquirylist.component */ "./src/app/inquiry/inquirylist.component.ts");
/* harmony import */ var _audit_audit_component__WEBPACK_IMPORTED_MODULE_66__ = __webpack_require__(/*! ./audit/audit.component */ "./src/app/audit/audit.component.ts");
/* harmony import */ var _audit_auditlist_component__WEBPACK_IMPORTED_MODULE_67__ = __webpack_require__(/*! ./audit/auditlist.component */ "./src/app/audit/auditlist.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _position_position_component__WEBPACK_IMPORTED_MODULE_50__["PositionComponent"],
                _position_position_list_component__WEBPACK_IMPORTED_MODULE_51__["PositionListComponent"],
                ...
                _offer_offer_component__WEBPACK_IMPORTED_MODULE_54__["OfferComponent"],
                _offer_offerlist_component__WEBPACK_IMPORTED_MODULE_55__["OfferlistComponent"],
                _settings_settings_component__WEBPACK_IMPORTED_MODULE_56__["SettingsComponent"],
                _settings_settingslist_component__WEBPACK_IMPORTED_MODULE_57__["SettingslistComponent"],
                _client_client_component__WEBPACK_IMPORTED_MODULE_58__["ClientComponent"],
                _client_clientlist_component__WEBPACK_IMPORTED_MODULE_59__["ClientlistComponent"],
                _activity_activitylist_component__WEBPACK_IMPORTED_MODULE_60__["ActivitylistComponent"],
                _activity_activity_component__WEBPACK_IMPORTED_MODULE_61__["ActivityComponent"],
                _contract_contract_component__WEBPACK_IMPORTED_MODULE_62__["ContractComponent"],
                _contract_contractlist_component__WEBPACK_IMPORTED_MODULE_63__["ContractlistComponent"],
                _inquiry_inquiry_component__WEBPACK_IMPORTED_MODULE_64__["InquiryComponent"],
                _inquiry_inquirylist_component__WEBPACK_IMPORTED_MODULE_65__["InquirylistComponent"],
                _audit_audit_component__WEBPACK_IMPORTED_MODULE_66__["AuditComponent"],
                _audit_auditlist_component__WEBPACK_IMPORTED_MODULE_67__["AuditlistComponent"]
            ],
            imports: [
...
module.exports = "<app-navbar></app-navbar>\r\n\r\n<style>\r\n  .grad {\r\n    background-image: linear-gradient(to bottom right, rgb(32,168,168), rgb(219,231,237));\r\n    background-repeat: no-repeat;\r\n    background-size: 100%;\r\n    padding-bottom: 25px;\r\n  }\r\n  .background {\r\n    padding-top: 3%;\r\n    padding-bottom: 13%;\r\n    background: url('assets/files/wall.jpg') no-repeat center center;\r\n    background-attachment: fixed;\r\n    background-size: cover;\r\n  }\r\n  .required-field { color: red; }\r\n  .alertRedColor { color: red; }\r\n</style>\r\n\r\n<div class=\"container-fluid background\" style=\"padding-top:12%\">\r\n  <div class=\"row justify-content-center\">\r\n    <div class=\"col-sm-8 col-md-6 col-lg-4\">\r\n      <div class=\"card\">\r\n        <div class=\"card-body shadow-lg grad\">\r\n\r\n          <form name=\"auditForm\" novalidate>\r\n\r\n            <h2 *ngIf=\"!form.data.id\" class=\"text-primary text-center font-weight-bold\">\r\n              Add Audit\r\n            </h2>\r\n            <h2 *ngIf=\"form.data.id\" class=\"text-primary text-center font-weight-bold\">\r\n              Update Audit\r\n            </h2>\r\n\r\n            <!-- Messages -->\r\n            <div *ngIf=\"form.error && form.message\"\r\n                 class=\"alert alert-danger alert-dismissible fade show\">\r\n              <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n              {{ form.message }}\r\n            </div>\r\n\r\n            <div *ngIf=\"!form.error && form.message\"\r\n                 class=\"alert alert-success alert-dismissible fade show\">\r\n              <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n              {{ form.message }}\r\n            </div>\r\n\r\n            <!-- Action Type -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Action Type</b><span class=\"required-field\">*</span></label>\r\n              <input type=\"text\" name=\"actionType\"\r\n                     [(ngModel)]=\"form.data.actionType\"\r\n                     class=\"form-control\"\r\n                     placeholder=\"Enter Action Type\">\r\n              <span *ngIf=\"form.inputerror.actionType\" class=\"alertRedColor\">\r\n                {{ form.inputerror.actionType }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Action By -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Action By</b><span class=\"required-field\">*</span></label>\r\n              <input type=\"text\" name=\"actionBy\"\r\n                     [(ngModel)]=\"form.data.actionBy\"\r\n                     class=\"form-control\"\r\n                     placeholder=\"Performed By\">\r\n              <span *ngIf=\"form.inputerror.actionBy\" class=\"alertRedColor\">\r\n                {{ form.inputerror.actionBy }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Action Time -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Action Time</b><span class=\"required-field\">*</span></label>\r\n              <input type=\"datetime-local\"\r\n                     name=\"actionTime\"\r\n                     (input)=\"form.data.actionTime=parseDate($event.target.value)\"\r\n                     class=\"form-control\">\r\n              <span *ngIf=\"form.inputerror.actionTime\" class=\"alertRedColor\">\r\n                {{ form.inputerror.actionTime }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Action Result -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Action Result</b><span class=\"required-field\">*</span></label>\r\n              <select class=\"form-control\"\r\n                      name=\"actionResult\"\r\n                      [(ngModel)]=\"form.data.actionResult\">\r\n                <option [ngValue]=\"undefined\">Select Result</option>\r\n                <option *ngFor=\"let r of form.preload?.resultList | keyvalue\"\r\n                        [value]=\"r.value\">\r\n                  {{ r.value }}\r\n                </option>\r\n              </select>\r\n              <span *ngIf=\"form.inputerror.actionResult\" class=\"alertRedColor\">\r\n                {{ form.inputerror.actionResult }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Buttons -->\r\n            <div class=\"row pt-2 pb-3\">\r\n              <div class=\"col-md-3\"></div>\r\n\r\n              <div class=\"pt-2\">\r\n                <button type=\"button\"\r\n                        *ngIf=\"!form.data.id\"\r\n                        (click)=\"submit()\"\r\n                        class=\"btn btn-success mr-2\">\r\n                  Save\r\n                </button>\r\n              </div>\r\n\r\n              <div class=\"col-md-1\"></div>\r\n\r\n              <div class=\"pt-2\">\r\n                <button type=\"button\"\r\n                        *ngIf=\"form.data.id\"\r\n                        (click)=\"submit()\"\r\n                        class=\"btn btn-success mr-2\">\r\n                  Update\r\n                </button>\r\n              </div>\r\n\r\n              <div class=\"pt-2\">\r\n                <a class=\"btn btn-warning mr-1\"\r\n                   [routerLink]=\"['/auditlist']\"\r\n                   style=\"color:white;text-decoration:none\">\r\n                  List\r\n                </a>\r\n              </div>\r\n            </div>\r\n\r\n          </form>\r\n\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<app-footer></app-footer>\r\n"
...
var AuditComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](AuditComponent, _super);
    function AuditComponent(locator, route) {
        return _super.call(this, locator.endpoints.AUDIT, locator, route) || this;
    }
    AuditComponent.prototype.validateForm = function (form) {
        var v = this.serviceLocator.dataValidator;
    ...
    AuditComponent.prototype.populateForm = function (form, data) {
        form.id = data.id;
...
/***/ "./src/app/audit/auditlist.component.html":
/*!************************************************!*\
  !*** ./src/app/audit/auditlist.component.html ***!
  \************************************************/
/*! no static exports found */
...
module.exports = "<app-navbar></app-navbar>\r\n\r\n<div class=\"content-wrapper\" style=\"padding-top:12%\">\r\n  <div class=\"container-fluid\">\r\n\r\n    <h1 class=\"text-primary text-center\">Audit List</h1>\r\n\r\n    <!-- Search -->\r\n    <div class=\"row search-inputs p-2 justify-content-center\">\r\n\r\n      <div class=\"col-sm-2\">\r\n        <input class=\"form-control\" [(ngModel)]=\"form.searchParams.actionType\" placeholder=\"Action Type\">\r\n      </div>\r\n\r\n      <div class=\"col-sm-2\">\r\n        <input class=\"form-control\" [(ngModel)]=\"form.searchParams.actionBy\" placeholder=\"Action By\">\r\n      </div>\r\n\r\n      <div class=\"col-sm-2\">\r\n        <select class=\"form-control\" [(ngModel)]=\"form.searchParams.actionResult\">\r\n          <option [ngValue]=\"undefined\">Result</option>\r\n          <option *ngFor=\"let r of form.preload?.resultList | keyvalue\" [value]=\"r.value\">\r\n            {{ r.value }}\r\n          </option>\r\n        </select>\r\n      </div>\r\n\r\n      <div class=\"col-sm-1\">\r\n        <button class=\"btn btn-primary w-100\" (click)=\"submit()\">Search</button>\r\n      </div>\r\n\r\n      <div>\r\n        <button class=\"btn btn-success w-100\" (click)=\"forward('/audit')\">\r\n          Add Audit\r\n        </button>\r\n      </div>\r\n\r\n      <div class=\"col-sm-1\">\r\n        <button class=\"btn btn-danger w-100\" (click)=\"deleteMany()\">Delete</button>\r\n      </div>\r\n    </div>\r\n\r\n    <!-- Messages -->\r\n    <div *ngIf=\"form.error && form.message\" class=\"alert alert-danger alert-dismissible fade show\">\r\n      <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n      {{ form.message }}\r\n    </div>\r\n\r\n    <div *ngIf=\"!form.error && form.message\" class=\"alert alert-success alert-dismissible fade show\">\r\n      <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n      {{ form.message }}\r\n    </div>\r\n\r\n    <!-- Table -->\r\n    <table class=\"table table-bordered table-dark mt-3\">\r\n      <thead>\r\n        <tr align=\"center\">\r\n          <th>\r\n            <input type=\"checkbox\" [(ngModel)]=\"isMasterSel\" (change)=\"checkUncheckAll($event)\">\r\n          </th>\r\n          <th>S.No</th>\r\n          <th>Action</th>\r\n          <th>By</th>\r\n          <th>Time</th>\r\n          <th>Result</th>\r\n          <th>Edit</th>\r\n        </tr>\r\n      </thead>\r\n\r\n      <tbody>\r\n        <tr *ngFor=\"let a of form.list; let i=index\" align=\"center\">\r\n          <td>\r\n            <input type=\"checkbox\" #checkboxes [id]=\"a.id\" (change)=\"checklistUpdate()\">\r\n          </td>\r\n          <td>{{ (form.pageNo * 5) + i + 1 }}</td>\r\n          <td>{{ a.actionType }}</td>\r\n          <td>{{ a.actionBy }}</td>\r\n          <td>{{ a.actionTime }}</td>\r\n          <td>{{ a.actionResult }}</td>\r\n          <td>\r\n            <button class=\"fa fa-edit text-primary\" (click)=\"forward('/audit/' + a.id)\">\r\n            </button>\r\n          </td>\r\n        </tr>\r\n      </tbody>\r\n    </table>\r\n\r\n    <!-- Pagination -->\r\n    <div class=\"d-flex justify-content-between mt-3\">\r\n      <button class=\"btn btn-info\" (click)=\"previous()\" [disabled]=\"form.pageNo == 0\">\r\n        Previous\r\n      </button>\r\n\r\n      <a class=\"btn btn-warning\" (click)=\"exit()\">\r\n        Reset\r\n      </a>\r\n\r\n      <button class=\"btn btn-info\" (click)=\"next()\" [disabled]=\"nextList == 0\">\r\n        Next\r\n      </button>\r\n    </div>\r\n\r\n  </div>\r\n</div>\r\n\r\n<app-footer></app-footer>"

/***/ }),

/***/ "./src/app/audit/auditlist.component.ts":
/*!**********************************************!*\
  !*** ./src/app/audit/auditlist.component.ts ***!
  \**********************************************/
/*! exports provided: AuditlistComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AuditlistComponent", function() { return AuditlistComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _base_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../base-list.component */ "./src/app/base-list.component.ts");
...
var AuditlistComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](AuditlistComponent, _super);
    function AuditlistComponent(locator, route) {
        return _super.call(this, locator.endpoints.AUDIT, locator, route) || this;
    }
    AuditlistComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-auditlist',
            template: __webpack_require__(/*! ./auditlist.component.html */ "./src/app/audit/auditlist.component.html")
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_locator_service__WEBPACK_IMPORTED_MODULE_4__["ServiceLocatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])
    ], AuditlistComponent);
...
module.exports = "<app-navbar></app-navbar>\r\n\r\n<style>\r\n  .grad {\r\n    background-image: linear-gradient(to bottom right, rgb(32, 168, 168), rgb(219, 231, 237));\r\n    background-repeat: no-repeat;\r\n    background-size: 100%;\r\n    padding-bottom: 25px;\r\n  }\r\n\r\n  .background {\r\n    padding-top: 3%;\r\n    padding-bottom: 13%;\r\n    background: url('assets/files/wall.jpg') no-repeat center center;\r\n    background-attachment: fixed;\r\n    background-size: cover;\r\n    width: 100%;\r\n    height: auto;\r\n  }\r\n\r\n  .required-field {\r\n    color: red;\r\n  }\r\n\r\n  .alertRedColor {\r\n    color: red;\r\n  }\r\n</style>\r\n\r\n<div class=\"container-fluid background\" style=\"padding-top: 12%\">\r\n  <div class=\"row justify-content-center\">\r\n    <div class=\"col-sm-8 col-md-6 col-lg-4\">\r\n      <div class=\"card\">\r\n        <div class=\"card-body shadow-lg grad\">\r\n\r\n          <form name=\"clientForm\">\r\n\r\n            <h2 *ngIf=\"!form.data.id\" class=\"text-primary font-weight-bold text-center\">\r\n              Add Client\r\n            </h2>\r\n            <h2 *ngIf=\"form.data.id\" class=\"text-primary font-weight-bold text-center\">\r\n              Update Client\r\n            </h2>\r\n\r\n            <!-- Messages -->\r\n            <div *ngIf=\"form.error && form.message\" class=\"alert alert-danger alert-dismissible fade show\">\r\n              <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n              {{ form.message }}\r\n            </div>\r\n\r\n            <div *ngIf=\"!form.error && form.message\" class=\"alert alert-success alert-dismissible fade show\">\r\n              <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n              {{ form.message }}\r\n            </div>\r\n\r\n            <!-- Client Name -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Client Name</b><span class=\"required-field\">*</span></label>\r\n              <input type=\"text\" name=\"clientName\" [(ngModel)]=\"form.data.clientName\" class=\"form-control\"\r\n                placeholder=\"Enter Client Name\">\r\n              <span *ngIf=\"form.inputerror.clientName\" class=\"alertRedColor\">\r\n                {{ form.inputerror.clientName }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Address -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Address</b><span class=\"required-field\">*</span></label>\r\n              <input type=\"text\" name=\"address\" [(ngModel)]=\"form.data.address\" class=\"form-control\"\r\n                placeholder=\"Enter Address\">\r\n              <span *ngIf=\"form.inputerror.address\" class=\"alertRedColor\">\r\n                {{ form.inputerror.address }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Phone -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Phone</b><span class=\"required-field\">*</span></label>\r\n              <input type=\"text\" name=\"phone\" [(ngModel)]=\"form.data.phone\" class=\"form-control\"\r\n                placeholder=\"Enter Phone\">\r\n              <span *ngIf=\"form.inputerror.phone\" class=\"alertRedColor\">\r\n                {{ form.inputerror.phone }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Priority -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Priority</b><span class=\"required-field\">*</span></label>\r\n              <select class=\"form-control\" name=\"priority\" [(ngModel)]=\"form.data.priority\">\r\n                <option [ngValue]=\"undefined\">Select Priority</option>\r\n                <option *ngFor=\"let p of form.preload.priorityList | keyvalue\" [value]=\"p.value\">\r\n                  {{ p.value }}\r\n                </option>\r\n              </select>\r\n              <span *ngIf=\"form.inputerror.priority\" class=\"alertRedColor\">\r\n                {{ form.inputerror.priority }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Buttons -->\r\n            <div class=\"row pt-2 pl-2 pb-3\">\r\n              <div class=\"col-md-3\"></div>\r\n\r\n              <div class=\"pt-2\">\r\n                <button *ngIf=\"!form.data.id > 0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\r\n                  Save\r\n                </button>\r\n              </div>\r\n\r\n              <div class=\"col-md-1\"></div>\r\n\r\n              <div class=\"pt-2\">\r\n                <button *ngIf=\"form.data.id > 0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\r\n                  Update\r\n                </button>\r\n              </div>\r\n\r\n              <div class=\"pt-2\">\r\n                <a class=\"btn btn-warning mr-1\" [routerLink]=\"['/clientlist']\" style=\"color:white;text-decoration:none\">\r\n                  List\r\n                </a>\r\n              </div>\r\n            </div>\r\n\r\n          </form>\r\n\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<app-footer></app-footer>"
...
var ClientComponent = /** @class */ (function (_super) {
    ...
    function ClientComponent(locator, route) {
        return _super.call(this, locator.endpoints.CLIENT, locator, route) || this;
    }
...
module.exports = "<app-navbar></app-navbar>\r\n\r\n<style>\r\n  .grad {\r\n    background-image: linear-gradient(to bottom right, rgb(32, 168, 168), rgb(219, 231, 237));\r\n    background-repeat: no-repeat;\r\n    background-size: 100%;\r\n    padding-bottom: 25px;\r\n  }\r\n\r\n  .background {\r\n    padding-top: 3%;\r\n    padding-bottom: 13%;\r\n    background: url('assets/files/wall.jpg') no-repeat center center;\r\n    background-attachment: fixed;\r\n    background-size: cover;\r\n    width: 100%;\r\n    height: auto;\r\n  }\r\n\r\n  .required-field {\r\n    color: red;\r\n  }\r\n\r\n  .alertRedColor {\r\n    color: red;\r\n  }\r\n</style>\r\n\r\n<div class=\"container-fluid background\" style=\"padding-top:12%\">\r\n  <div class=\"row justify-content-center\">\r\n    <div class=\"col-sm-8 col-md-6 col-lg-4\">\r\n      <div class=\"card\">\r\n        <div class=\"card-body shadow-lg grad\">\r\n\r\n          <form name=\"contractForm\">\r\n\r\n            <h2 *ngIf=\"!form.data.id\" class=\"text-primary font-weight-bold text-center\">\r\n              Add Contract\r\n            </h2>\r\n            <h2 *ngIf=\"form.data.id\" class=\"text-primary font-weight-bold text-center\">\r\n              Update Contract\r\n            </h2>\r\n\r\n            <!-- Messages -->\r\n            <div *ngIf=\"form.error && form.message\" class=\"alert alert-danger alert-dismissible fade show\">\r\n              <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n              {{ form.message }}\r\n            </div>\r\n\r\n            <div *ngIf=\"!form.error && form.message\" class=\"alert alert-success alert-dismissible fade show\">\r\n              <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n              {{ form.message }}\r\n            </div>\r\n\r\n            <!-- Name -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Name</b><span class=\"required-field\">*</span></label>\r\n              <input type=\"text\" name=\"name\" [(ngModel)]=\"form.data.name\" class=\"form-control\" placeholder=\"Enter Name\">\r\n              <span *ngIf=\"form.inputerror.name\" class=\"alertRedColor\">\r\n                {{ form.inputerror.name }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- City -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>City</b><span class=\"required-field\">*</span></label>\r\n              <select class=\"form-control\" name=\"city\" [(ngModel)]=\"form.data.city\">\r\n                <option [ngValue]=\"undefined\">Select City</option>\r\n                <option *ngFor=\"let c of form.preload.cityList | keyvalue\" [value]=\"c.value\">\r\n                  {{ c.value }}\r\n                </option>\r\n              </select>\r\n              <span *ngIf=\"form.inputerror.city\" class=\"alertRedColor\">\r\n                {{ form.inputerror.city }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- DOB -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Date of Birth</b><span class=\"required-field\">*</span></label>\r\n              <input type=\"date\" name=\"dob\" [value]=\"form.data.dob | date:'yyyy-MM-dd'\"\r\n                (input)=\"form.data.dob=parseDate($event.target.value)\" class=\"form-control\">\r\n              <span *ngIf=\"form.inputerror.dob\" class=\"alertRedColor\">\r\n                {{ form.inputerror.dob }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Mobile -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Mobile No</b><span class=\"required-field\">*</span></label>\r\n              <input type=\"number\" name=\"mobileNo\" [(ngModel)]=\"form.data.mobileNo\" class=\"form-control\"\r\n                placeholder=\"Enter Mobile Number\">\r\n              <span *ngIf=\"form.inputerror.mobileNo\" class=\"alertRedColor\">\r\n                {{ form.inputerror.mobileNo }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Buttons -->\r\n            <div class=\"row pt-2 pl-2 pb-3\">\r\n              <div class=\"col-md-3\"></div>\r\n\r\n              <div class=\"pt-2\">\r\n                <button *ngIf=\"!form.data.id > 0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\r\n                  Save\r\n                </button>\r\n              </div>\r\n\r\n              <div class=\"col-md-1\"></div>\r\n\r\n              <div class=\"pt-2\">\r\n                <button *ngIf=\"form.data.id > 0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\r\n                  Update\r\n                </button>\r\n              </div>\r\n\r\n              <div class=\"pt-2\">\r\n                <a class=\"btn btn-warning mr-1\" [routerLink]=\"['/contractlist']\"\r\n                  style=\"color:white;text-decoration:none\">\r\n                  List\r\n                </a>\r\n              </div>\r\n            </div>\r\n\r\n          </form>\r\n\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<app-footer></app-footer>"
...
var ContractComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ContractComponent, _super);
    function ContractComponent(locator, route) {
        return _super.call(this, locator.endpoints.CONTRACT, locator, route) || this;
    }
    ContractComponent.prototype.validateForm = function (form) {
        var v = this.serviceLocator.dataValidator;
    ...
    ContractComponent.prototype.populateForm = function (form, data) {
        form.id = data.id;
        form.name = data.name;
        form.city = data.city;
        form.dob = data.dob;
...
/***/ "./src/app/contract/contractlist.component.html":
/*!******************************************************!*\
  !*** ./src/app/contract/contractlist.component.html ***!
  \******************************************************/
/*! no static exports found */
...
module.exports = "<app-navbar></app-navbar>\r\n\r\n<div class=\"content-wrapper\" style=\"padding-top:12%\">\r\n  <div class=\"container-fluid\">\r\n\r\n    <h1 class=\"text-primary text-center\">Contract List</h1>\r\n\r\n    <!-- Search -->\r\n    <div class=\"row search-inputs p-2 justify-content-center\">\r\n\r\n      <div class=\"col-sm-2\">\r\n        <input type=\"text\" class=\"form-control\" [(ngModel)]=\"form.searchParams.name\" placeholder=\"Name\">\r\n      </div>\r\n\r\n      <div class=\"col-sm-2\">\r\n        <select class=\"form-control\" [(ngModel)]=\"form.searchParams.city\">\r\n          <option [ngValue]=\"undefined\">Select City</option>\r\n          <option *ngFor=\"let c of form.preload.cityList | keyvalue\" [value]=\"c.value\">\r\n            {{ c.value }}\r\n          </option>\r\n        </select>\r\n      </div>\r\n\r\n      <div class=\"col-sm-1\">\r\n        <button class=\"btn btn-primary w-100\" (click)=\"submit()\">Search</button>\r\n      </div>\r\n\r\n      <div>\r\n        <button class=\"btn btn-success w-100\" (click)=\"forward('/contract')\">\r\n          Add Contract\r\n        </button>\r\n      </div>\r\n\r\n      <div class=\"col-sm-1\">\r\n        <button class=\"btn btn-danger w-100\" (click)=\"deleteMany()\">Delete</button>\r\n      </div>\r\n    </div>\r\n\r\n    <!-- Messages -->\r\n    <div *ngIf=\"form.error && form.message\" class=\"alert alert-danger alert-dismissible fade show\">\r\n      <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n      {{ form.message }}\r\n    </div>\r\n\r\n    <div *ngIf=\"!form.error && form.message\" class=\"alert alert-success alert-dismissible fade show\">\r\n      <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n      {{ form.message }}\r\n    </div>\r\n\r\n    <!-- Table -->\r\n    <table class=\"table table-bordered table-dark mt-3\">\r\n      <thead>\r\n        <tr align=\"center\">\r\n          <th>\r\n            <input type=\"checkbox\" [(ngModel)]=\"isMasterSel\" (change)=\"checkUncheckAll($event)\">\r\n          </th>\r\n          <th>S.No</th>\r\n          <th>Name</th>\r\n          <th>City</th>\r\n          <th>DOB</th>\r\n          <th>Mobile</th>\r\n          <th>Edit</th>\r\n        </tr>\r\n      </thead>\r\n\r\n      <tbody>\r\n        <tr *ngFor=\"let c of form.list; let i=index\" align=\"center\">\r\n          <td>\r\n            <input type=\"checkbox\" #checkboxes [id]=\"c.id\" (change)=\"checklistUpdate()\">\r\n          </td>\r\n          <td>{{ (form.pageNo * 5) + i + 1 }}</td>\r\n          <td>{{ c.name }}</td>\r\n          <td>{{ c.city }}</td>\r\n          <td>{{ c.dob }}</td>\r\n          <td>{{ c.mobileNo }}</td>\r\n          <td>\r\n            <button class=\"fa fa-edit text-primary\" (click)=\"forward('/contract/' + c.id)\">\r\n            </button>\r\n          </td>\r\n        </tr>\r\n      </tbody>\r\n    </table>\r\n\r\n    <!-- Pagination + Reset -->\r\n    <div class=\"d-flex justify-content-between mt-3\">\r\n\r\n      <button class=\"btn btn-info\" (click)=\"previous()\" [disabled]=\"form.pageNo == 0\">\r\n        Previous\r\n      </button>\r\n\r\n      <div>\r\n        <a class=\"btn btn-warning mr-1\" [routerLink]=\"['/contractlist']\" (click)=\"exit()\">\r\n          Reset\r\n        </a>\r\n      </div>\r\n\r\n      <button class=\"btn btn-info\" (click)=\"next()\" [disabled]=\"nextList == 0\">\r\n        Next\r\n      </button>\r\n\r\n    </div>\r\n\r\n  </div>\r\n</div>\r\n\r\n<app-footer></app-footer>"

/***/ }),

/***/ "./src/app/contract/contractlist.component.ts":
/*!****************************************************!*\
  !*** ./src/app/contract/contractlist.component.ts ***!
  \****************************************************/
...
var ContractlistComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](ContractlistComponent, _super);
    function ContractlistComponent(locator, route) {
        return _super.call(this, locator.endpoints.CONTRACT, locator, route) || this;
    }
    ContractlistComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-contractlist',
            template: __webpack_require__(/*! ./contractlist.component.html */ "./src/app/contract/contractlist.component.html")
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_locator_service__WEBPACK_IMPORTED_MODULE_4__["ServiceLocatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])
...
var EndpointServiceService = /** @class */ (function () {
    function EndpointServiceService() {
        ...
        this.OFFER = this.SERVER_URL + "/Offer";
        this.SETTINGS = this.SERVER_URL + "/Settings";
        this.CLIENT = this.SERVER_URL + "/Client";
        this.ACTIVITY = this.SERVER_URL + "/Activity";
        this.CONTRACT = this.SERVER_URL + "/Contract";
        this.INQUIRY = this.SERVER_URL + "/Inquiry";
        this.AUDIT = this.SERVER_URL + "/Audit";
    }
...
var HttpServiceService = /** @class */ (function () {
    ...
    HttpServiceService.prototype.post = function (endpoint, bean, callback, errorCallback) {
        ...
        return this.httpClient.post(endpoint, bean).subscribe(function (data) {
            ...
            console.log('ORS Error--', error);
            var msg = 'Service is currently unavailable';
...
/***/ "./src/app/inquiry/inquiry.component.html":
/*!************************************************!*\
  !*** ./src/app/inquiry/inquiry.component.html ***!
  \************************************************/
/*! no static exports found */
...
module.exports = "<app-navbar></app-navbar>\r\n\r\n<style>\r\n  .grad {\r\n    background-image: linear-gradient(to bottom right, rgb(32,168,168), rgb(219,231,237));\r\n    background-repeat: no-repeat;\r\n    background-size: 100%;\r\n    padding-bottom: 25px;\r\n  }\r\n  .background {\r\n    padding-top: 3%;\r\n    padding-bottom: 13%;\r\n    background: url('assets/files/wall.jpg') no-repeat center center;\r\n    background-attachment: fixed;\r\n    background-size: cover;\r\n  }\r\n  .required-field { color: red; }\r\n  .alertRedColor { color: red; }\r\n</style>\r\n\r\n<div class=\"container-fluid background\" style=\"padding-top:12%\">\r\n  <div class=\"row justify-content-center\">\r\n    <div class=\"col-sm-8 col-md-6 col-lg-4\">\r\n      <div class=\"card\">\r\n        <div class=\"card-body shadow-lg grad\">\r\n\r\n          <form name=\"inquiryForm\">\r\n\r\n            <h2 *ngIf=\"!form.data.id\" class=\"text-primary text-center font-weight-bold\">\r\n              Add Inquiry\r\n            </h2>\r\n            <h2 *ngIf=\"form.data.id\" class=\"text-primary text-center font-weight-bold\">\r\n              Update Inquiry\r\n            </h2>\r\n\r\n            <!-- Messages -->\r\n            <div *ngIf=\"form.error && form.message\" class=\"alert alert-danger alert-dismissible fade show\">\r\n              <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n              {{ form.message }}\r\n            </div>\r\n\r\n            <div *ngIf=\"!form.error && form.message\" class=\"alert alert-success alert-dismissible fade show\">\r\n              <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n              {{ form.message }}\r\n            </div>\r\n\r\n            <!-- Inquirer Name -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Inquirer Name</b><span class=\"required-field\">*</span></label>\r\n              <input type=\"text\" name=\"inquirerName\"\r\n                     [(ngModel)]=\"form.data.inquirerName\"\r\n                     class=\"form-control\"\r\n                     placeholder=\"Enter Name\">\r\n              <span *ngIf=\"form.inputerror.inquirerName\" class=\"alertRedColor\">\r\n                {{ form.inputerror.inquirerName }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Email -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Email</b><span class=\"required-field\">*</span></label>\r\n              <input type=\"email\" name=\"email\"\r\n                     [(ngModel)]=\"form.data.email\"\r\n                     class=\"form-control\"\r\n                     placeholder=\"Enter Email\">\r\n              <span *ngIf=\"form.inputerror.email\" class=\"alertRedColor\">\r\n                {{ form.inputerror.email }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Subject -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Inquiry Subject</b><span class=\"required-field\">*</span></label>\r\n              <input type=\"text\" name=\"inquirySubject\"\r\n                     [(ngModel)]=\"form.data.inquirySubject\"\r\n                     class=\"form-control\"\r\n                     placeholder=\"Enter Subject\">\r\n              <span *ngIf=\"form.inputerror.inquirySubject\" class=\"alertRedColor\">\r\n                {{ form.inputerror.inquirySubject }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Status -->\r\n            <div class=\"form-group pt-2\">\r\n              <label><b>Status</b><span class=\"required-field\">*</span></label>\r\n              <select class=\"form-control\"\r\n                      name=\"inquiryStatus\"\r\n                      [(ngModel)]=\"form.data.inquiryStatus\">\r\n                <option [ngValue]=\"undefined\">Select Status</option>\r\n                <option *ngFor=\"let s of form.preload.statusList | keyvalue\"\r\n                        [value]=\"s.value\">\r\n                  {{ s.value }}\r\n                </option>\r\n              </select>\r\n              <span *ngIf=\"form.inputerror.inquiryStatus\" class=\"alertRedColor\">\r\n                {{ form.inputerror.inquiryStatus }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Buttons -->\r\n            <div class=\"row pt-2 pb-3\">\r\n              <div class=\"col-md-3\"></div>\r\n\r\n              <div class=\"pt-2\">\r\n                <button *ngIf=\"!form.data.id > 0\"\r\n                        (click)=\"submit()\"\r\n                        class=\"btn btn-success mr-2\">\r\n                  Save\r\n                </button>\r\n              </div>\r\n\r\n              <div class=\"col-md-1\"></div>\r\n\r\n              <div class=\"pt-2\">\r\n                <button *ngIf=\"form.data.id > 0\"\r\n                        (click)=\"submit()\"\r\n                        class=\"btn btn-success mr-2\">\r\n                  Update\r\n                </button>\r\n              </div>\r\n\r\n              <div class=\"pt-2\">\r\n                <a class=\"btn btn-warning mr-1\"\r\n                   [routerLink]=\"['/inquirylist']\"\r\n                   style=\"color:white;text-decoration:none\">\r\n                  List\r\n                </a>\r\n              </div>\r\n            </div>\r\n\r\n          </form>\r\n\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<app-footer></app-footer>\r\n"
...
var InquiryComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](InquiryComponent, _super);
    function InquiryComponent(locator, route) {
        return _super.call(this, locator.endpoints.INQUIRY, locator, route) || this;
    }
    InquiryComponent.prototype.validateForm = function (form) {
        var v = this.serviceLocator.dataValidator;
    ...
    InquiryComponent.prototype.populateForm = function (form, data) {
        form.id = data.id;
    ...
    InquiryComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./inquiry.component.html */ "./src/app/inquiry/inquiry.component.html")
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_locator_service__WEBPACK_IMPORTED_MODULE_4__["ServiceLocatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])
    ], InquiryComponent);
...
/***/ "./src/app/inquiry/inquirylist.component.html":
/*!****************************************************!*\
  !*** ./src/app/inquiry/inquirylist.component.html ***!
  \****************************************************/
/*! no static exports found */
...
module.exports = "<app-navbar></app-navbar>\r\n\r\n<div class=\"content-wrapper\" style=\"padding-top:12%\">\r\n  <div class=\"container-fluid\">\r\n\r\n    <h1 class=\"text-primary text-center\">Inquiry List</h1>\r\n\r\n    <!-- Search -->\r\n    <div class=\"row search-inputs p-2 justify-content-center\">\r\n\r\n      <div class=\"col-sm-2\">\r\n        <input type=\"text\" class=\"form-control\" [(ngModel)]=\"form.searchParams.inquirerName\" placeholder=\"Name\">\r\n      </div>\r\n\r\n      <div class=\"col-sm-2\">\r\n        <input type=\"text\" class=\"form-control\" [(ngModel)]=\"form.searchParams.email\" placeholder=\"Email\">\r\n      </div>\r\n\r\n      <div class=\"col-sm-2\">\r\n        <select class=\"form-control\" [(ngModel)]=\"form.searchParams.inquiryStatus\">\r\n          <option [ngValue]=\"undefined\">Select Status</option>\r\n          <option *ngFor=\"let s of form.preload.statusList | keyvalue\" [value]=\"s.value\">\r\n            {{ s.value }}\r\n          </option>\r\n        </select>\r\n      </div>\r\n\r\n      <div class=\"col-sm-1\">\r\n        <button class=\"btn btn-primary w-100\" (click)=\"submit()\">Search</button>\r\n      </div>\r\n\r\n      <div>\r\n        <button class=\"btn btn-success w-100\" (click)=\"forward('/inquiry')\">\r\n          Add Inquiry\r\n        </button>\r\n      </div>\r\n\r\n      <div class=\"col-sm-1\">\r\n        <button class=\"btn btn-danger w-100\" (click)=\"deleteMany()\">Delete</button>\r\n      </div>\r\n    </div>\r\n\r\n    <!-- Messages -->\r\n    <div *ngIf=\"form.error && form.message\" class=\"alert alert-danger alert-dismissible fade show\">\r\n      <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n      {{ form.message }}\r\n    </div>\r\n\r\n    <div *ngIf=\"!form.error && form.message\" class=\"alert alert-success alert-dismissible fade show\">\r\n      <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n      {{ form.message }}\r\n    </div>\r\n\r\n    <!-- Table -->\r\n    <table class=\"table table-bordered table-dark mt-3\">\r\n      <thead>\r\n        <tr align=\"center\">\r\n          <th>\r\n            <input type=\"checkbox\" [(ngModel)]=\"isMasterSel\" (change)=\"checkUncheckAll($event)\">\r\n          </th>\r\n          <th>S.No</th>\r\n          <th>Name</th>\r\n          <th>Email</th>\r\n          <th>Subject</th>\r\n          <th>Status</th>\r\n          <th>Edit</th>\r\n        </tr>\r\n      </thead>\r\n\r\n      <tbody>\r\n        <tr *ngFor=\"let i of form.list; let idx=index\" align=\"center\">\r\n          <td>\r\n            <input type=\"checkbox\" #checkboxes [id]=\"i.id\" (change)=\"checklistUpdate()\">\r\n          </td>\r\n          <td>{{ (form.pageNo * 5) + idx + 1 }}</td>\r\n          <td>{{ i.inquirerName }}</td>\r\n          <td>{{ i.email }}</td>\r\n          <td>{{ i.inquirySubject }}</td>\r\n          <td>{{ i.inquiryStatus }}</td>\r\n          <td>\r\n            <button class=\"fa fa-edit text-primary\" (click)=\"forward('/inquiry/' + i.id)\">\r\n            </button>\r\n          </td>\r\n        </tr>\r\n      </tbody>\r\n    </table>\r\n\r\n    <!-- Pagination -->\r\n    <div class=\"d-flex justify-content-between mt-3\">\r\n      <button class=\"btn btn-info\" (click)=\"previous()\" [disabled]=\"form.pageNo == 0\">\r\n        Previous\r\n      </button>\r\n\r\n      <a class=\"btn btn-warning\" [routerLink]=\"['/inquirylist']\" (click)=\"exit()\">Reset</a>\r\n\r\n      <button class=\"btn btn-info\" (click)=\"next()\" [disabled]=\"nextList == 0\">\r\n        Next\r\n      </button>\r\n    </div>\r\n\r\n  </div>\r\n</div>\r\n\r\n<app-footer></app-footer>"

/***/ }),

/***/ "./src/app/inquiry/inquirylist.component.ts":
/*!**************************************************!*\
  !*** ./src/app/inquiry/inquirylist.component.ts ***!
  \**************************************************/
/*! exports provided: InquirylistComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "InquirylistComponent", function() { return InquirylistComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _base_list_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../base-list.component */ "./src/app/base-list.component.ts");
...
var InquirylistComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](InquirylistComponent, _super);
    function InquirylistComponent(locator, route) {
        return _super.call(this, locator.endpoints.INQUIRY, locator, route) || this;
    }
    InquirylistComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-inquirylist',
            template: __webpack_require__(/*! ./inquirylist.component.html */ "./src/app/inquiry/inquirylist.component.html")
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_locator_service__WEBPACK_IMPORTED_MODULE_4__["ServiceLocatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])
    ], InquirylistComponent);
    return InquirylistComponent;
}(_base_list_component__WEBPACK_IMPORTED_MODULE_3__["BaseListCtl"]));
...
module.exports = "<app-navbar></app-navbar>\r\n\r\n<style>\r\n  .grad {\r\n    background-image: linear-gradient(to bottom right, rgb(32, 168, 168), rgb(219, 231, 237));\r\n    background-repeat: no-repeat;\r\n    background-size: 100%;\r\n    padding-bottom: 25px;\r\n  }\r\n\r\n  .background {\r\n    padding-top: 3%;\r\n    padding-bottom: 13%;\r\n    background: url('assets/files/wall.jpg') no-repeat center center;\r\n    background-attachment: fixed;\r\n    background-size: cover;\r\n    width: 100%;\r\n    height: auto;\r\n  }\r\n\r\n  .required-field {\r\n    color: red;\r\n  }\r\n\r\n  .alertRedColor {\r\n    color: red;\r\n  }\r\n</style>\r\n\r\n<div class=\"container-fluid background\" style=\"padding-top: 12%\">\r\n  <div class=\"row justify-content-center\">\r\n    <div class=\"col-sm-8 col-md-6 col-lg-4\">\r\n      <div class=\"card\">\r\n        <div class=\"card-body shadow-lg grad\">\r\n\r\n          <form name=\"offerForm\">\r\n\r\n            <h2 *ngIf=\"!form.data.id\" class=\"text-primary font-weight-bold\" style=\"text-align: center;\">\r\n              {{ 'Add Offer' | translate }}\r\n            </h2>\r\n            <h2 *ngIf=\"form.data.id\" class=\"text-primary font-weight-bold\" style=\"text-align: center;\">\r\n              {{ 'Update Offer' | translate }}\r\n            </h2>\r\n\r\n            <!-- Form error messages -->\r\n            <div *ngIf=\"form.error && form.message\" class=\"alert alert-danger alert-dismissible fade show\">\r\n              <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n              {{ form.message }}\r\n            </div>\r\n            <div *ngIf=\"!form.error && form.message\" class=\"alert alert-success alert-dismissible fade show\">\r\n              <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n              {{ form.message }}\r\n            </div>\r\n\r\n            <!-- Offer Code -->\r\n            <div class=\"form-group pt-2\">\r\n              <label>\r\n                <b>{{ 'Offer Code' | translate }}</b>\r\n                <span class=\"required-field\">*</span>\r\n              </label>\r\n\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-tag grey-text\"></i></div>\r\n                </div>\r\n\r\n                <input type=\"text\" name=\"offerCode\" [(ngModel)]=\"form.data.offerCode\" class=\"form-control\"\r\n                  maxlength=\"20\" placeholder=\"{{ 'Enter Offer Code' | translate }}\">\r\n              </div>\r\n\r\n              <span *ngIf=\"form.inputerror.offerCode\" class=\"alertRedColor\">\r\n                {{ form.inputerror.offerCode }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Discount Amount -->\r\n            <div class=\"form-group pt-2\">\r\n              <label>\r\n                <b>{{ 'Discount Amount' | translate }}</b>\r\n                <span class=\"required-field\">*</span>\r\n              </label>\r\n\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-rupee-sign grey-text\"></i></div>\r\n                </div>\r\n\r\n                <input type=\"number\" name=\"discountAmount\" [(ngModel)]=\"form.data.discountAmount\" class=\"form-control\"\r\n                  placeholder=\"{{ 'Enter Discount Amount' | translate }}\">\r\n              </div>\r\n\r\n              <span *ngIf=\"form.inputerror.discountAmount\" class=\"alertRedColor\">\r\n                {{ form.inputerror.discountAmount }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Expiry Date -->\r\n            <div class=\"form-group pt-2\">\r\n              <label>\r\n                <b>{{ 'Expiry Date' | translate }}</b>\r\n                <span class=\"required-field\">*</span>\r\n              </label>\r\n\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-calendar grey-text\"></i></div>\r\n                </div>\r\n\r\n                <input type=\"date\" name=\"expiryDate\" [value]=\"form.data.expiryDate | date:'yyyy-MM-dd'\"\r\n                  (input)=\"form.data.expiryDate=parseDate($event.target.value)\" class=\"form-control form-control-sm\"\r\n                  required />\r\n              </div>\r\n\r\n              <span *ngIf=\"form.inputerror.expiryDate\" class=\"alertRedColor\">\r\n                {{ form.inputerror.expiryDate }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Offer Status -->\r\n            <div class=\"form-group pt-2\">\r\n              <label>\r\n                <b>{{ 'Offer Status' | translate }}</b>\r\n                <span class=\"required-field\">*</span>\r\n              </label>\r\n\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\"><i class=\"fa fa-toggle-on grey-text\"></i></div>\r\n                </div>\r\n\r\n                <select class=\"form-control\" name=\"offerStatus\" [(ngModel)]=\"form.data.offerStatus\"\r\n                  aria-label=\"ngSelected\" required>\r\n                  <option [ngValue]=\"undefined\">{{ 'Select Status' | translate }}</option>\r\n                  <option value=\"ACTIVE\">{{ 'ACTIVE' | translate }}</option>\r\n                  <option value=\"INACTIVE\">{{ 'INACTIVE' | translate }}</option>\r\n                  <option value=\"EXPIRED\">{{ 'EXPIRED' | translate }}</option>\r\n                </select>\r\n              </div>\r\n\r\n              <span *ngIf=\"form.inputerror.offerStatus\" class=\"alertRedColor\">\r\n                {{ form.inputerror.offerStatus }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Buttons -->\r\n            <div class=\"row pt-2 pl-2 pb-3\">\r\n\r\n              <div class=\"col-md-3\"></div>\r\n\r\n              <div class=\"pt-2\">\r\n                <button *ngIf=\"!form.data.id > 0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\r\n                  {{ 'Save' | translate }}\r\n                </button>\r\n              </div>\r\n\r\n              <div class=\"col-md-1\"></div>\r\n\r\n              <div class=\"pt-2\">\r\n                <button *ngIf=\"form.data.id > 0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\r\n                  {{ 'Update' | translate }}\r\n                </button>\r\n              </div>\r\n\r\n              <div class=\"pt-2\">\r\n                <a class=\"btn btn-warning mr-1\" type=\"button\" [routerLink]=\"['/offerlist']\"\r\n                  style=\"text-decoration: none; color: white;\">\r\n                  {{ 'List' | translate }}\r\n                </a>\r\n              </div>\r\n\r\n            </div>\r\n\r\n          </form>\r\n\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<app-footer></app-footer>"
...
var OfferComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](OfferComponent, _super);
    function OfferComponent(locator, route) {
        var _this = _super.call(this, locator.endpoints.OFFER, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
        _this.errorMessageTitle = '';
        _this.errorMessageOfferCode = '';
        return _this;
    }
    OfferComponent.prototype.onUpload = function (userform) {
        this.submit();
        console.log(this.form.data.id + '---- after submit');
    };
    OfferComponent.prototype.validateForm = function (form) {
        var flag = true;
        var validator = this.serviceLocator.dataValidator;
    ...
    OfferComponent.prototype.populateForm = function (form, data) {
        form.id = data.id;
    ...
    OfferComponent.prototype.validateName = function (event) {
        var inputValue = event.target.value;
        var inputChar = event.key;
    ...
    OfferComponent.prototype.validateAlphabetInput = function (event) {
        var charCode = event.which || event.keyCode;
        var charStr = String.fromCharCode(charCode);
        if (!/^[a-zA-Z]+$/.test(charStr)) {
            event.preventDefault();
...
/***/ "./src/app/offer/offerlist.component.css":
/*!***********************************************!*\
  !*** ./src/app/offer/offerlist.component.css ***!
  \***********************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL29mZmVyL29mZmVybGlzdC5jb21wb25lbnQuY3NzIn0= */"

/***/ }),

/***/ "./src/app/offer/offerlist.component.html":
/*!************************************************!*\
  !*** ./src/app/offer/offerlist.component.html ***!
  \************************************************/
/*! no static exports found */
...
module.exports = "<app-navbar></app-navbar>\r\n\r\n<style>\r\n  #nnn {\r\n    background: none;\r\n    border: none;\r\n    cursor: pointer;\r\n  }\r\n\r\n  .panel-heading {\r\n    height: 50px;\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n  }\r\n\r\n  .search-inputs {\r\n    margin-top: 20px;\r\n  }\r\n\r\n  .search-inputs .form-control,\r\n  .search-inputs .btn {\r\n    margin-bottom: 10px;\r\n  }\r\n\r\n  .content-wrapper {\r\n    background: url('assets/files/teahu.png') no-repeat center center;\r\n    background-attachment: fixed;\r\n    background-size: cover;\r\n    width: auto;\r\n    height: 105vh;\r\n    padding: 20px;\r\n  }\r\n\r\n  .table-responsive {\r\n    margin-top: 20px;\r\n  }\r\n\r\n  .search-inputs .col-sm-2,\r\n  .search-inputs .col-sm-1 {\r\n    padding: 0 5px;\r\n  }\r\n\r\n  .alertRedColor {\r\n    color: red;\r\n  }\r\n</style>\r\n\r\n<div class=\"content-wrapper \">\r\n  <div class=\"container-fluid\">\r\n    <div class=\"panel panel-primary\" style=\"padding-top: 12%;\">\r\n      <div class=\"panel-heading\">\r\n        <h1 class=\"text-primary font-weight-bold\">{{ 'Offer List' | translate }}</h1>\r\n      </div>\r\n\r\n      <!-- SEARCH BAR -->\r\n      <div class=\"row search-inputs p-1 justify-content-center g-3\">\r\n\r\n        <div class=\"col-sm-2\">\r\n          <input type=\"text\"\r\n                 name=\"offerCode\"\r\n                 [(ngModel)]=\"form.searchParams.offerCode\"\r\n                 class=\"form-control\"\r\n                 placeholder=\"{{ 'Enter Offer Code' | translate }}\">\r\n        </div>\r\n\r\n        <div class=\"col-sm-2\">\r\n          <input type=\"date\"\r\n                 name=\"expiryDate\"\r\n                 [(ngModel)]=\"form.searchParams.expiryDate\"\r\n                 class=\"form-control\">\r\n        </div>\r\n\r\n        <div class=\"col-sm-2\">\r\n          <input type=\"number\"\r\n                 name=\"discountAmount\"\r\n                 [(ngModel)]=\"form.searchParams.discountAmount\"\r\n                 class=\"form-control\"\r\n                 placeholder=\"{{ 'Enter Discount Amount' | translate }}\">\r\n        </div>\r\n\r\n        <div class=\"col-sm-2\">\r\n          <select class=\"form-control\"\r\n                  name=\"offerStatus\"\r\n                  [(ngModel)]=\"form.searchParams.offerStatus\">\r\n            <option [ngValue]=\"undefined\">{{ 'Select Status' | translate }}</option>\r\n            <option value=\"ACTIVE\">ACTIVE</option>\r\n            <option value=\"INACTIVE\">INACTIVE</option>\r\n            <option value=\"EXPIRED\">EXPIRED</option>\r\n          </select>\r\n        </div>\r\n\r\n        <!-- SEARCH -->\r\n        <div class=\"col-sm-1\">\r\n          <button type=\"button\"\r\n                  (click)=\"search()\"\r\n                  class=\"btn btn-primary w-100\">\r\n            {{ 'Search' | translate }}\r\n          </button>\r\n        </div>\r\n\r\n        <!-- ADD -->\r\n        <div>\r\n          <button type=\"button\"\r\n                  (click)=\"forward('/offer')\"\r\n                  class=\"btn btn-success w-100\">\r\n            {{ 'Add Offer' | translate }}\r\n          </button>\r\n        </div>\r\n\r\n        <!-- DELETE -->\r\n        <div class=\"col-sm-1\">\r\n          <button type=\"button\"\r\n                  (click)=\"deleteMany()\"\r\n                  class=\"btn btn-danger w-100\">\r\n            {{ 'Delete' | translate }}\r\n          </button>\r\n        </div>\r\n\r\n      </div>\r\n\r\n      <!-- MESSAGE -->\r\n      <div *ngIf=\"form.error\" class=\"alert alert-danger alert-dismissible\">\r\n        <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n        {{ form.message }}\r\n      </div>\r\n\r\n      <div *ngIf=\"!form.error && form.message != null\"\r\n           class=\"alert alert-success alert-dismissible\">\r\n        <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n        {{ form.message }}\r\n      </div>\r\n\r\n      <!-- TABLE -->\r\n      <div class=\"table-responsive\">\r\n        <table class=\"table table-bordered table-hover table-dark\">\r\n          <thead class=\"thead-dark text-uppercase\">\r\n            <tr align=\"center\">\r\n              <th>\r\n                <input type=\"checkbox\"\r\n                       [(ngModel)]=\"isMasterSel\"\r\n                       name=\"list_name\"\r\n                       (change)=\"checkUncheckAll($event)\" />\r\n              </th>\r\n              <th>S.No</th>\r\n              <th>Offer Code</th>\r\n              <th>Expiry Date</th>\r\n              <th>Discount Amount</th>\r\n              <th>Status</th>\r\n              <th>Edit</th>\r\n            </tr>\r\n          </thead>\r\n\r\n          <tbody>\r\n            <tr *ngFor=\"let m of form.list; let i = index\" align=\"center\">\r\n              <td>\r\n                <input type=\"checkbox\"\r\n                       #checkboxes\r\n                       name=\"list_name\"\r\n                       [id]=\"m.id\"\r\n                       (change)=\"checklistUpdate()\" />\r\n              </td>\r\n              <td>{{ (form.pageNo * 5) + i + 1 }}</td>\r\n              <td>{{ m.offerCode }}</td>\r\n              <td>{{ m.expiryDate }}</td>\r\n              <td>{{ m.discountAmount }}</td>\r\n              <td>{{ m.offerStatus }}</td>\r\n              <td>\r\n                <button id=\"nnn\"\r\n                        class=\"fa fa-edit text-primary\"\r\n                        (click)=\"forward('/offer/' + m.id)\">\r\n                </button>\r\n              </td>\r\n            </tr>\r\n          </tbody>\r\n        </table>\r\n\r\n        <!-- PAGINATION -->\r\n        <div class=\"d-flex justify-content-between mt-3\">\r\n          <button type=\"button\"\r\n                  (click)=\"previous()\"\r\n                  [disabled]=\"form.pageNo == 0\"\r\n                  class=\"btn btn-info\">\r\n            {{ 'Previous' | translate }}\r\n          </button>\r\n\r\n          <a class=\"btn btn-warning mr-1\"\r\n             [routerLink]=\"['/offerlist']\"\r\n             (click)=\"exit()\">\r\n            {{ 'Reset' | translate }}\r\n          </a>\r\n\r\n          <button type=\"button\"\r\n                  (click)=\"next()\"\r\n                  [disabled]=\"nextList == 0\"\r\n                  class=\"btn btn-info\">\r\n            {{ 'Next' | translate }}\r\n          </button>\r\n        </div>\r\n\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<app-footer></app-footer>\r\n"

/***/ }),

/***/ "./src/app/offer/offerlist.component.ts":
/*!**********************************************!*\
  !*** ./src/app/offer/offerlist.component.ts ***!
  \**********************************************/
...
var OfferlistComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](OfferlistComponent, _super);
    function OfferlistComponent(locator, route, httpClient) {
        var _this = _super.call(this, locator.endpoints.OFFER, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
        _this.httpClient = httpClient;
    ...
    OfferlistComponent.prototype.validateFullName = function (event) {
        var inputValue = event.target.value;
        var inputChar = event.key;
        var alphabetPattern = /^[a-zA-Z]*$/;
        if (!alphabetPattern.test(inputChar) && !['Backspace', 'Delete', 'Tab'].includes(inputChar)) {
    ...
    OfferlistComponent.prototype.validateAlphabetInput = function (event) {
        var charCode = event.which || event.keyCode;
        var charStr = String.fromCharCode(charCode);
        if (!/^[a-zA-Z]+$/.test(charStr)) {
            event.preventDefault();
    ...
    OfferlistComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-offerlist',
            template: __webpack_require__(/*! ./offerlist.component.html */ "./src/app/offer/offerlist.component.html"),
            styles: [__webpack_require__(/*! ./offerlist.component.css */ "./src/app/offer/offerlist.component.css")]
        }),
...
var OrderComponent = /** @class */ (function (_super) {
    ...
    OrderComponent.prototype.validateName = function (event) {
        var inputValue = event.target.value;
        var inputChar = event.key;
        var alphabetPattern = /^[a-zA-Z]*$/; // Pattern to match only alphabetic characters
        if (!alphabetPattern.test(inputChar) && !['Backspace', 'Delete', 'Tab'].includes(inputChar)) {
...
module.exports = "<app-navbar></app-navbar>\r\n\r\n<style>\r\n  #nnn {\r\n    background: none;\r\n    border: none;\r\n    cursor: pointer;\r\n  }\r\n\r\n  .panel-heading {\r\n    height: 50px;\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n  }\r\n\r\n  .search-inputs {\r\n    margin-top: 20px;\r\n  }\r\n\r\n  .search-inputs .form-control,\r\n  .search-inputs .btn {\r\n    margin-bottom: 10px;\r\n  }\r\n\r\n  .content-wrapper {\r\n    background: url('assets/files/teahu.png') no-repeat center center;\r\n    background-attachment: fixed;\r\n    background-size: cover;\r\n    width: auto;\r\n    height: 105vh;\r\n    padding: 20px;\r\n  }\r\n\r\n  .table-responsive {\r\n    margin-top: 20px;\r\n  }\r\n\r\n  .search-inputs .col-sm-2,\r\n  .search-inputs .col-sm-1 {\r\n    padding: 0 5px;\r\n  }\r\n\r\n  .alertRedColor {\r\n    color: red;\r\n  }\r\n</style>\r\n\r\n<div class=\"content-wrapper \">\r\n  <div class=\"container-fluid\">\r\n    <div class=\"panel panel-primary\" style=\"padding-top: 12%;\">\r\n      <div class=\"panel-heading\">\r\n        <h1 class=\"text-primary font-weight-bold\">{{ 'Offer List' | translate }}</h1>\r\n      </div>\r\n\r\n      <!-- SEARCH SECTION -->\r\n      <div class=\"row search-inputs p-1 justify-content-center g-3\">\r\n\r\n        <!-- Offer Code -->\r\n        <div class=\"col-sm-2\">\r\n          <input type=\"text\" name=\"offerCode\" [(ngModel)]=\"form.searchParams.offerCode\" class=\"form-control\"\r\n            placeholder=\"{{ 'Enter Offer Code' | translate }}\">\r\n          <span *ngIf=\"errorMessageOfferCode\" class=\"alertRedColor\">\r\n            {{ errorMessageOfferCode }}\r\n          </span>\r\n        </div>\r\n\r\n        <!-- Expiry Date -->\r\n        <div class=\"col-sm-2\">\r\n          <input type=\"date\" name=\"expiryDate\" [(ngModel)]=\"form.searchParams.expiryDate\" class=\"form-control\"\r\n            placeholder=\"{{ 'Enter Expiry Date' | translate }}\">\r\n        </div>\r\n\r\n        <!-- Discount Amount -->\r\n        <div class=\"col-sm-2\">\r\n          <input type=\"number\" name=\"discountAmount\" [(ngModel)]=\"form.searchParams.discountAmount\" class=\"form-control\"\r\n            placeholder=\"{{ 'Enter Discount Amount' | translate }}\">\r\n        </div>\r\n\r\n        <!-- Offer Status -->\r\n        <div class=\"col-sm-2\">\r\n          <select class=\"form-control\" name=\"offerStatus\" [(ngModel)]=\"form.searchParams.offerStatus\"\r\n            aria-label=\"ngSelected\">\r\n            <option [ngValue]=\"undefined\">{{ 'Select Status' | translate }}</option>\r\n            <option value=\"ACTIVE\">{{ 'ACTIVE' | translate }}</option>\r\n            <option value=\"INACTIVE\">{{ 'INACTIVE' | translate }}</option>\r\n            <option value=\"EXPIRED\">{{ 'EXPIRED' | translate }}</option>\r\n          </select>\r\n        </div>\r\n\r\n        <!-- Buttons -->\r\n        <div class=\"col-sm-1\">\r\n          <button (click)=\"submit()\" class=\"btn btn-primary w-100\">\r\n            {{ 'Search' | translate }}\r\n          </button>\r\n        </div>\r\n\r\n        <div>\r\n          <button (click)=\"forward('/offer')\" type=\"button\" class=\"btn btn-success w-100\">\r\n            {{ 'Add Offer' | translate }}\r\n          </button>\r\n        </div>\r\n\r\n        <div class=\"col-sm-1\">\r\n          <button (click)=\"deleteMany()\" class=\"btn btn-danger w-100\">\r\n            {{ 'Delete' | translate }}\r\n          </button>\r\n        </div>\r\n      </div>\r\n\r\n      <!-- ERROR / SUCCESS MESSAGES -->\r\n      <div *ngIf=\"form.error\" class=\"alert alert-danger alert-dismissible\">\r\n        <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n        {{ form.message }}\r\n      </div>\r\n\r\n      <div *ngIf=\"!form.error && form.message != null\" class=\"alert alert-success alert-dismissible\">\r\n        <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n        {{ form.message }}\r\n      </div>\r\n\r\n      <!-- TABLE -->\r\n      <div class=\"table-responsive\">\r\n        <table class=\"table table-bordered table-hover table-dark\">\r\n          <thead class=\"thead-dark text-uppercase\">\r\n            <tr align=\"center\">\r\n              <th>\r\n                <input type=\"checkbox\" [(ngModel)]=\"isMasterSel\" name=\"list_name\" (change)=\"checkUncheckAll($event)\" />\r\n              </th>\r\n              <th>{{ 'S.No' | translate }}</th>\r\n              <th>{{ 'Offer Code' | translate }}</th>\r\n              <th>{{ 'Expiry Date' | translate }}</th>\r\n              <th>{{ 'Discount Amount' | translate }}</th>\r\n              <th>{{ 'Status' | translate }}</th>\r\n              <th>{{ 'Edit' | translate }}</th>\r\n            </tr>\r\n          </thead>\r\n\r\n          <tbody>\r\n            <tr *ngFor=\"let m of form.list; let i = index\" align=\"center\">\r\n              <td>\r\n                <input type=\"checkbox\" #checkboxes (change)=\"checklistUpdate()\" name=\"list_name\" [id]=\"m.id\" />\r\n              </td>\r\n              <td>{{ (form.pageNo * 5) + i + 1 }}</td>\r\n              <td>{{ m.offerCode }}</td>\r\n              <td>{{ m.expiryDate }}</td>\r\n              <td>{{ m.discountAmount }}</td>\r\n              <td>{{ m.offerStatus }}</td>\r\n              <td>\r\n                <button class=\"fa fa-edit text-primary\" id=\"nnn\" (click)=\"forward('/offer/' + m.id)\">\r\n                </button>\r\n              </td>\r\n            </tr>\r\n          </tbody>\r\n        </table>\r\n\r\n        <!-- PAGINATION -->\r\n        <div class=\"d-flex justify-content-between mt-3\">\r\n          <button (click)=\"previous()\" [disabled]=\"form.pageNo == 0\" class=\"btn btn-info\">\r\n            {{ 'Previous' | translate }}\r\n          </button>\r\n\r\n          <div>\r\n            <a class=\"btn btn-warning mr-1\" [routerLink]=\"['/offerlist']\" (click)=\"exit()\">\r\n              {{ 'Reset' | translate }}\r\n            </a>\r\n          </div>\r\n\r\n          <div *ngIf=\"form.list.length == 0\">\r\n            <a class=\"btn btn-warning mr-1\" [routerLink]=\"['/offerlist']\" (click)=\"exit()\">\r\n              {{ 'Back' | translate }}\r\n            </a>\r\n          </div>\r\n\r\n          <button (click)=\"next()\" [disabled]=\"nextList == 0\" class=\"btn btn-info\">\r\n            {{ 'Next' | translate }}\r\n          </button>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<app-footer></app-footer>"
...
var OrderlistComponent = /** @class */ (function (_super) {
    ...
    OrderlistComponent.prototype.validateFullName = function (event) {
        var inputValue = event.target.value;
        var inputChar = event.key;
        var alphabetPattern = /^[a-zA-Z]*$/; // Pattern to match only alphabetic characters
        if (!alphabetPattern.test(inputChar) && !['Backspace', 'Delete', 'Tab'].includes(inputChar)) {
...
var PositionListComponent = /** @class */ (function (_super) {
    ...
    PositionListComponent.prototype.validateFullName = function (event) {
        var inputValue = event.target.value;
        var inputChar = event.key;
        var alphabetPattern = /^[a-zA-Z]*$/; // Pattern to match only alphabetic characters
        if (!alphabetPattern.test(inputChar) && !['Backspace', 'Delete', 'Tab'].includes(inputChar)) {
    ...
    PositionListComponent.prototype.validateAlphabetInput = function (event) {
        var charCode = event.which || event.keyCode;
        var charStr = String.fromCharCode(charCode);
        // Regular expression to test if the character is a letter
        if (!/^[a-zA-Z]+$/.test(charStr)) {
...
var PositionComponent = /** @class */ (function (_super) {
    ...
    PositionComponent.prototype.validateName = function (event) {
        var inputValue = event.target.value;
        var inputChar = event.key;
        var alphabetPattern = /^[a-zA-Z]*$/; // Pattern to match only alphabetic characters
        if (!alphabetPattern.test(inputChar) && !['Backspace', 'Delete', 'Tab'].includes(inputChar)) {
    ...
    PositionComponent.prototype.validateAlphabetInput = function (event) {
        var charCode = event.which || event.keyCode;
        var charStr = String.fromCharCode(charCode);
        // Regular expression to test if the character is a letter
        if (!/^[a-zA-Z]+$/.test(charStr)) {
...
module.exports = "<app-navbar></app-navbar>\r\n\r\n<style>\r\n  .grad {\r\n    background-image: linear-gradient(to bottom right, rgb(32, 168, 168), rgb(219, 231, 237));\r\n    background-repeat: no-repeat;\r\n    background-size: 100%;\r\n    padding-bottom: 25px;\r\n  }\r\n\r\n  .background {\r\n    padding-top: 3%;\r\n    padding-bottom: 13%;\r\n    background: url('assets/files/wall.jpg') no-repeat center center;\r\n    background-attachment: fixed;\r\n    background-size: cover;\r\n    width: 100%;\r\n    height: auto;\r\n  }\r\n\r\n  .required-field {\r\n    color: red;\r\n  }\r\n\r\n  .alertRedColor {\r\n    color: red;\r\n  }\r\n</style>\r\n\r\n<div class=\"container-fluid background\" style=\"padding-top: 12%\">\r\n  <div class=\"row justify-content-center\">\r\n    <div class=\"col-sm-8 col-md-6 col-lg-4\">\r\n      <div class=\"card\">\r\n        <div class=\"card-body shadow-lg grad\">\r\n\r\n          <form name=\"settingsForm\">\r\n\r\n            <h2 *ngIf=\"!form.data.id\" class=\"text-primary font-weight-bold\" style=\"text-align: center;\">\r\n              {{ 'Add Setting' | translate }}\r\n            </h2>\r\n\r\n            <h2 *ngIf=\"form.data.id\" class=\"text-primary font-weight-bold\" style=\"text-align: center;\">\r\n              {{ 'Update Setting' | translate }}\r\n            </h2>\r\n\r\n            <!-- Error message -->\r\n            <div *ngIf=\"form.error && form.message\" class=\"alert alert-danger alert-dismissible fade show\">\r\n              <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n              {{ form.message }}\r\n            </div>\r\n\r\n            <!-- Success message -->\r\n            <div *ngIf=\"!form.error && form.message\" class=\"alert alert-success alert-dismissible fade show\">\r\n              <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n              {{ form.message }}\r\n            </div>\r\n\r\n\r\n            <!-- Setting Name -->\r\n            <div class=\"form-group pt-2\">\r\n              <label>\r\n                <b>{{ 'Setting Name' | translate }}</b>\r\n                <span class=\"required-field\">*</span>\r\n              </label>\r\n\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\">\r\n                    <i class=\"fa fa-cog grey-text\"></i>\r\n                  </div>\r\n                </div>\r\n\r\n                <input type=\"text\" name=\"settingName\" [(ngModel)]=\"form.data.settingName\" class=\"form-control\"\r\n                  maxlength=\"50\" placeholder=\"{{ 'Enter Setting Name' | translate }}\">\r\n              </div>\r\n\r\n              <span *ngIf=\"form.inputerror.settingName\" class=\"alertRedColor\">\r\n                {{ form.inputerror.settingName }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Setting Value -->\r\n            <div class=\"form-group pt-2\">\r\n              <label>\r\n                <b>{{ 'Setting Value' | translate }}</b>\r\n                <span class=\"required-field\">*</span>\r\n              </label>\r\n\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\">\r\n                    <i class=\"fa fa-pencil-alt grey-text\"></i>\r\n                  </div>\r\n                </div>\r\n\r\n                <input type=\"text\" name=\"settingValue\" [(ngModel)]=\"form.data.settingValue\" class=\"form-control\"\r\n                  placeholder=\"{{ 'Enter Setting Value' | translate }}\">\r\n              </div>\r\n\r\n              <span *ngIf=\"form.inputerror.settingValue\" class=\"alertRedColor\">\r\n                {{ form.inputerror.settingValue }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Setting Type -->\r\n            <div class=\"form-group pt-2\">\r\n              <label>\r\n                <b>{{ 'Setting Type' | translate }}</b>\r\n                <span class=\"required-field\">*</span>\r\n              </label>\r\n\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\">\r\n                    <i class=\"fa fa-list grey-text\"></i>\r\n                  </div>\r\n                </div>\r\n\r\n                <select class=\"form-control\" name=\"settingType\" [(ngModel)]=\"form.data.settingType\"\r\n                  aria-label=\"ngSelected\">\r\n                  <option [ngValue]=\"undefined\">\r\n                    {{ 'Select Type' | translate }}\r\n                  </option>\r\n                  <option *ngFor=\"let t of form.preload.settingTypeList | keyvalue\" [value]=\"t.value\">\r\n                    {{ t.value }}\r\n                  </option>\r\n                </select>\r\n              </div>\r\n\r\n              <span *ngIf=\"form.inputerror.settingType\" class=\"alertRedColor\">\r\n                {{ form.inputerror.settingType }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Setting Status -->\r\n            <div class=\"form-group pt-2\">\r\n              <label>\r\n                <b>{{ 'Setting Status' | translate }}</b>\r\n                <span class=\"required-field\">*</span>\r\n              </label>\r\n\r\n              <div class=\"input-group\">\r\n                <div class=\"input-group-prepend\">\r\n                  <div class=\"input-group-text\">\r\n                    <i class=\"fa fa-toggle-on grey-text\"></i>\r\n                  </div>\r\n                </div>\r\n\r\n                <select class=\"form-control\" name=\"settingStatus\" [(ngModel)]=\"form.data.settingStatus\"\r\n                  aria-label=\"ngSelected\">\r\n                  <option [ngValue]=\"undefined\">\r\n                    {{ 'Select Status' | translate }}\r\n                  </option>\r\n                  <option *ngFor=\"let s of form.preload.settingStatusList | keyvalue\" [value]=\"s.value\">\r\n                    {{ s.value }}\r\n                  </option>\r\n                </select>\r\n              </div>\r\n\r\n              <span *ngIf=\"form.inputerror.settingStatus\" class=\"alertRedColor\">\r\n                {{ form.inputerror.settingStatus }}\r\n              </span>\r\n            </div>\r\n\r\n            <!-- Buttons -->\r\n            <div class=\"row pt-2 pl-2 pb-3\">\r\n\r\n              <div class=\"col-md-3\"></div>\r\n\r\n              <div class=\"pt-2\">\r\n                <button *ngIf=\"!form.data.id > 0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\r\n                  {{ 'Save' | translate }}\r\n                </button>\r\n              </div>\r\n\r\n              <div class=\"col-md-1\"></div>\r\n\r\n              <div class=\"pt-2\">\r\n                <button *ngIf=\"form.data.id > 0\" (click)=\"submit()\" class=\"btn btn-success mr-2\">\r\n                  {{ 'Update' | translate }}\r\n                </button>\r\n              </div>\r\n\r\n              <div class=\"pt-2\">\r\n                <a class=\"btn btn-warning mr-1\" type=\"button\" [routerLink]=\"['/settingslist']\"\r\n                  style=\"text-decoration: none; color: white;\">\r\n                  {{ 'List' | translate }}\r\n                </a>\r\n              </div>\r\n\r\n            </div>\r\n\r\n          </form>\r\n\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<app-footer></app-footer>"
...
var SettingsComponent = /** @class */ (function (_super) {
    ...
    function SettingsComponent(locator, route) {
        var _this = _super.call(this, locator.endpoints.SETTINGS, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
        return _this;
    }
    SettingsComponent.prototype.validateForm = function (form) {
        var validator = this.serviceLocator.dataValidator;
        var flag = true;
    ...
    SettingsComponent.prototype.populateForm = function (form, data) {
        form.id = data.id;
...
/***/ "./src/app/settings/settingslist.component.css":
/*!*****************************************************!*\
  !*** ./src/app/settings/settingslist.component.css ***!
  \*****************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3NldHRpbmdzL3NldHRpbmdzbGlzdC5jb21wb25lbnQuY3NzIn0= */"

/***/ }),

/***/ "./src/app/settings/settingslist.component.html":
/*!******************************************************!*\
  !*** ./src/app/settings/settingslist.component.html ***!
  \******************************************************/
/*! no static exports found */
...
module.exports = "<app-navbar></app-navbar>\r\n\r\n<style>\r\n  #nnn {\r\n    background: none;\r\n    border: none;\r\n    cursor: pointer;\r\n  }\r\n\r\n  .panel-heading {\r\n    height: 50px;\r\n    display: flex;\r\n    align-items: center;\r\n    justify-content: center;\r\n  }\r\n\r\n  .search-inputs {\r\n    margin-top: 20px;\r\n  }\r\n\r\n  .search-inputs .form-control,\r\n  .search-inputs .btn {\r\n    margin-bottom: 10px;\r\n  }\r\n\r\n  .content-wrapper {\r\n    background: url('assets/files/teahu.png') no-repeat center center;\r\n    background-attachment: fixed;\r\n    background-size: cover;\r\n    width: auto;\r\n    height: 105vh;\r\n    padding: 20px;\r\n  }\r\n\r\n  .table-responsive {\r\n    margin-top: 20px;\r\n  }\r\n\r\n  .search-inputs .col-sm-2,\r\n  .search-inputs .col-sm-1 {\r\n    padding: 0 5px;\r\n  }\r\n\r\n  .alertRedColor {\r\n    color: red;\r\n  }\r\n</style>\r\n\r\n<div class=\"content-wrapper\">\r\n  <div class=\"container-fluid\">\r\n    <div class=\"panel panel-primary\" style=\"padding-top: 12%;\">\r\n\r\n      <!-- HEADER -->\r\n      <div class=\"panel-heading\">\r\n        <h1 class=\"text-primary font-weight-bold\">\r\n          {{ 'Settings List' | translate }}\r\n        </h1>\r\n      </div>\r\n\r\n      <!-- SEARCH BAR -->\r\n      <div class=\"row search-inputs p-1 justify-content-center g-3\">\r\n\r\n        <div class=\"col-sm-2\">\r\n          <input type=\"text\" class=\"form-control\" name=\"settingName\" [(ngModel)]=\"form.searchParams.settingName\"\r\n            placeholder=\"{{ 'Enter Setting Name' | translate }}\">\r\n        </div>\r\n\r\n        <div class=\"col-sm-2\">\r\n          <select class=\"form-control\" name=\"settingStatus\" [(ngModel)]=\"form.searchParams.settingStatus\">\r\n            <option [ngValue]=\"undefined\">\r\n              {{ 'Select Status' | translate }}\r\n            </option>\r\n            <option *ngFor=\"let s of form.preload.settingStatusList | keyvalue\" [value]=\"s.value\">\r\n              {{ s.value }}\r\n            </option>\r\n          </select>\r\n        </div>\r\n\r\n        <!-- SEARCH -->\r\n        <div class=\"col-sm-1\">\r\n          <button type=\"button\" (click)=\"search()\" class=\"btn btn-primary w-100\">\r\n            {{ 'Search' | translate }}\r\n          </button>\r\n        </div>\r\n\r\n        <!-- ADD -->\r\n        <div>\r\n          <button type=\"button\" (click)=\"forward('/settings')\" class=\"btn btn-success w-100\">\r\n            {{ 'Add Setting' | translate }}\r\n          </button>\r\n        </div>\r\n\r\n        <!-- DELETE -->\r\n        <div class=\"col-sm-1\">\r\n          <button type=\"button\" (click)=\"deleteMany()\" class=\"btn btn-danger w-100\">\r\n            {{ 'Delete' | translate }}\r\n          </button>\r\n        </div>\r\n\r\n      </div>\r\n\r\n      <!-- MESSAGE -->\r\n      <div *ngIf=\"form.error\" class=\"alert alert-danger alert-dismissible\">\r\n        <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n        {{ form.message }}\r\n      </div>\r\n\r\n      <div *ngIf=\"!form.error && form.message != null\" class=\"alert alert-success alert-dismissible\">\r\n        <button type=\"button\" class=\"close\" data-dismiss=\"alert\">&times;</button>\r\n        {{ form.message }}\r\n      </div>\r\n\r\n      <!-- TABLE -->\r\n      <div class=\"table-responsive\">\r\n        <table class=\"table table-bordered table-hover table-dark\">\r\n          <thead class=\"thead-dark text-uppercase\">\r\n            <tr align=\"center\">\r\n              <th>\r\n                <input type=\"checkbox\" [(ngModel)]=\"isMasterSel\" (change)=\"checkUncheckAll($event)\" />\r\n              </th>\r\n              <th>S.No</th>\r\n              <th>Setting Name</th>\r\n              <th>Setting Value</th>\r\n              <th>Setting Type</th>\r\n              <th>Status</th>\r\n              <th>Edit</th>\r\n            </tr>\r\n          </thead>\r\n\r\n          <tbody>\r\n            <tr *ngFor=\"let m of form.list; let i = index\" align=\"center\">\r\n              <td>\r\n                <input type=\"checkbox\" #checkboxes [id]=\"m.id\" (change)=\"checklistUpdate()\" />\r\n              </td>\r\n              <td>{{ (form.pageNo * 5) + i + 1 }}</td>\r\n              <td>{{ m.settingName }}</td>\r\n              <td>{{ m.settingValue }}</td>\r\n              <td>{{ m.settingType }}</td>\r\n              <td>{{ m.settingStatus }}</td>\r\n              <td>\r\n                <button id=\"nnn\" class=\"fa fa-edit text-primary\" (click)=\"forward('/settings/' + m.id)\">\r\n                </button>\r\n              </td>\r\n            </tr>\r\n          </tbody>\r\n        </table>\r\n      </div>\r\n\r\n      <!-- PAGINATION -->\r\n      <div class=\"d-flex justify-content-between mt-3\">\r\n\r\n        <button type=\"button\" (click)=\"previous()\" [disabled]=\"form.pageNo == 0\" class=\"btn btn-info\">\r\n          {{ 'Previous' | translate }}\r\n        </button>\r\n\r\n        <div>\r\n          <a class=\"btn btn-warning mr-1\" [routerLink]=\"['/settingslist']\" (click)=\"exit()\">\r\n            {{ 'Reset' | translate }}\r\n          </a>\r\n        </div>\r\n\r\n        <div *ngIf=\"form.list.length == 0\">\r\n          <a class=\"btn btn-warning mr-1\" [routerLink]=\"['/settingslist']\" (click)=\"exit()\">\r\n            {{ 'Back' | translate }}\r\n          </a>\r\n        </div>\r\n\r\n        <button type=\"button\" (click)=\"next()\" [disabled]=\"nextList == 0\" class=\"btn btn-info\">\r\n          {{ 'Next' | translate }}\r\n        </button>\r\n\r\n      </div>\r\n\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n<app-footer></app-footer>"

/***/ }),

/***/ "./src/app/settings/settingslist.component.ts":
/*!****************************************************!*\
  !*** ./src/app/settings/settingslist.component.ts ***!
  \****************************************************/
...
var SettingslistComponent = /** @class */ (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__["__extends"](SettingslistComponent, _super);
    function SettingslistComponent(locator, route) {
        var _this = _super.call(this, locator.endpoints.SETTINGS, locator, route) || this;
        _this.locator = locator;
        _this.route = route;
        return _this;
    ...
    SettingslistComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! ./settingslist.component.html */ "./src/app/settings/settingslist.component.html"),
            styles: [__webpack_require__(/*! ./settingslist.component.css */ "./src/app/settings/settingslist.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_service_locator_service__WEBPACK_IMPORTED_MODULE_3__["ServiceLocatorService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["ActivatedRoute"]])
...
module.exports = __webpack_require__(/*! D:\Workspace\Project_10\ORSProject10-UI\src\main.ts */"./src/main.ts");
